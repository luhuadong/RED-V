...
# 1 "applications/led/led.h" 1
# 12 "applications/led/led.h"
#define __LED_H__ 
...
const char __fsym___cmd_give_me_five_name[] __attribute__((section(".rodata.name"))) = "__cmd_give_me_five"; const char __fsym___cmd_give_me_five_desc[] __attribute__((section(".rodata.name"))) = "Show the SiFive logo"; __attribute__((used)) const struct finsh_syscall __fsym___cmd_give_me_five __attribute__((section("FSymTab")))= { __fsym___cmd_give_me_five_name, __fsym___cmd_give_me_five_desc, (syscall_func)&give_me_five };
