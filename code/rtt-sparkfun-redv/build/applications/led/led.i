...
# 14 "applications/led/led.c" 2
# 1 "freedom-e-sdk/bsp/include/sifive/devices/gpio.h" 1
# 15 "applications/led/led.c" 2
...
# 16 "applications/led/led.c" 2

#define USER_LED_OFFSET 5

static void _led_init(rt_uint8_t offset)
{
    (*(volatile uint32_t *) (((0x10012000UL)) + ((0x38)))) &= ~(1UL << offset);

    (*(volatile uint32_t *) (((0x10012000UL)) + ((0x08)))) |= (1UL << offset);
}
...
static void _led_set(rt_uint8_t offset, rt_uint8_t val)
{
    ...
    {
        case 1:
            (*(volatile uint32_t *) (((0x10012000UL)) + ((0x0C)))) |= (1UL << offset);
            break;
        case 0:
            (*(volatile uint32_t *) (((0x10012000UL)) + ((0x0C)))) &= ~(1UL << offset);
            break;
