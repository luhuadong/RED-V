...
.LFB19:
	...
	.cfi_endproc
.LFE19:
	.size	usart_handler, .-usart_handler
	.section	.rodata
	.align	2
.LC0:
...
.L4:
	...
	.cfi_endproc
.LFE20:
	.size	usart_configure, .-usart_configure
	.align	1
	.type	usart_control, @function
usart_control:
.LFB21:
	.loc 1 54 1
	.cfi_startproc
...
.L7:
	...
	.cfi_endproc
.LFE21:
	.size	usart_control, .-usart_control
	.align	1
...
.LC2:
	...
	.align	2
.LC3:
	.string	"uart interrupt"
	.text
	.align	1
	.globl	rt_hw_uart_init
...
.LFB24:
	...
	lla	a3,.LC3
	lla	a2,serial
	lla	a1,usart_handler
	li	a0,3
	call	rt_hw_interrupt_install
	.loc 1 120 5
	li	a0,3
	call	rt_hw_interrupt_unmask
	.loc 1 122 12
	li	a5,0
	.loc 1 123 1
	mv	a0,a5
...
.LFE24:
	...
	.globl	__rt_init_rt_hw_uart_init
	.section	.rti_fn.1,"a"
	.align	2
	.type	__rt_init_rt_hw_uart_init, @object
	.size	__rt_init_rt_hw_uart_init, 4
__rt_init_rt_hw_uart_init:
	.word	rt_hw_uart_init
	.section	.rodata
	.align	2
	.type	__FUNCTION__.3436, @object
	.size	__FUNCTION__.3436, 16
__FUNCTION__.3436:
	.string	"usart_configure"
	.align	2
	.type	__FUNCTION__.3442, @object
	.size	__FUNCTION__.3442, 14
__FUNCTION__.3442:
	.string	"usart_control"
	.text
.Letext0:
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	__rt_init_rt_hw_uart_init
	.byte	0x2a
	.4byte	.LASF3154
	.byte	0x1
	.byte	0x69
...
.Ldebug_macro0:
	...
	.byte	0x4
	.4byte	.LASF316
	.file 14 "/home/rudy/workspace/Projects/rt-thread/components/drivers/include/rtdevice.h"
	.byte	0x3
	.byte	0x18
	.byte	0xe
	.byte	0x5
	...
	.4byte	.LASF1683
	.byte	0x4
	.file 67 "/home/rudy/workspace/Projects/rt-thread/components/drivers/include/ipc/dataqueue.h"
	.byte	0x3
	.byte	0x13
	.byte	0x43
	.byte	0x7
	...
	.byte	0x4
	.file 68 "/home/rudy/workspace/Projects/rt-thread/components/drivers/include/ipc/workqueue.h"
	.byte	0x3
	.byte	0x14
	.byte	0x44
	.byte	0x5
...
.LASF3141:
	.string	"__rt_init_rt_hw_uart_init"
.LASF2712:
