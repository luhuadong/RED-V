...
# 29 "drivers/interrupt.c" 2

#define MAX_HANDLERS PLIC_NUM_INTERRUPTS


static struct rt_irq_desc irq_desc[52];
...
void rt_hw_interrupt_init(void)
{
    ...
    ({ unsigned long __tmp; if (__builtin_constant_p((1 << 11)) && (unsigned long)((1 << 11)) < 32) asm volatile ("csrrs %0, " "mie" ", %1" : "=r"(__tmp) : "i"((1 << 11))); else asm volatile ("csrrs %0, " "mie" ", %1" : "=r"(__tmp) : "r"((1 << 11))); __tmp; });
}
