...
# 29 "drivers/drv_usart.c" 2

static void usart_handler(int vector, void *param)
{
    rt_hw_serial_isr((struct rt_serial_device *)param, 0x01);
}

static rt_err_t usart_configure(struct rt_serial_device *serial,
                                struct serial_configure *cfg)
{
    if (!(serial != (0))) { rt_assert_handler("serial != RT_NULL", __FUNCTION__, 38); };
    if (!(cfg != (0))) { rt_assert_handler("cfg != RT_NULL", __FUNCTION__, 39); };

    (*(volatile uint32_t *) (((0x10012000UL)) + ((0x3C)))) &= ~(0x00030000UL);
    (*(volatile uint32_t *) (((0x10012000UL)) + ((0x38)))) |= (0x00030000UL);

    (*(volatile uint32_t *) (((0x10013000UL)) + (0x18))) = get_cpu_freq() / cfg->baud_rate - 1;
    (*(volatile uint32_t *) (((0x10013000UL)) + (0x08))) |= 0x1;
    (*(volatile uint32_t *) (((0x10013000UL)) + (0x0c))) |= 0x1;
    (*(volatile uint32_t *) (((0x10013000UL)) + (0x10))) = 0x2;
...
static rt_err_t usart_control(struct rt_serial_device *serial,
                              int cmd, void *arg)
{
    if (!(serial != (0))) { rt_assert_handler("serial != RT_NULL", __FUNCTION__, 55); };
...
{
    while ((*(volatile uint32_t *) (((0x10013000UL)) + (0x00))) & 0x80000000) ;
    (*(volatile uint32_t *) (((0x10013000UL)) + (0x00))) = c;
...
{
    rt_int32_t val = (*(volatile uint32_t *) (((0x10013000UL)) + (0x04)));
    if (val > 0)
...
int rt_hw_uart_init(void)
{
    ...
    rt_hw_interrupt_unmask(3);

    return 0;
}
__attribute__((used)) const init_fn_t __rt_init_rt_hw_uart_init __attribute__((section(".rti_fn." "1"))) = rt_hw_uart_init;
