...
{
    (*((volatile uint64_t *)((0x02000000UL) + 0x4000))) = (*((volatile uint64_t *)((0x02000000UL) + 0xBFF8))) + (32768 / 100);
    rt_tick_increase();
}
...
static void rt_hw_timer_init(void)
{
    ...
    ({ unsigned long __tmp; if (__builtin_constant_p((1 << 7)) && (unsigned long)((1 << 7)) < 32) asm volatile ("csrrs %0, " "mie" ", %1" : "=r"(__tmp) : "i"((1 << 7))); else asm volatile ("csrrs %0, " "mie" ", %1" : "=r"(__tmp) : "r"((1 << 7))); __tmp; });
}
