# 1 "freedom-e-sdk/bsp/env/freedom-e300-hifive1/init.c"
...
# 2 "freedom-e-sdk/bsp/env/freedom-e300-hifive1/init.c" 2
...
# 30 "/home/rudy/opt/FreedomStudio/SiFive/riscv64-unknown-elf-gcc-8.3.0-2020.04.1/riscv64-unknown-elf/include/stdio.h" 2 3
...
# 36 "/home/rudy/opt/FreedomStudio/SiFive/riscv64-unknown-elf-gcc-8.3.0-2020.04.1/riscv64-unknown-elf/include/stdio.h" 2 3
# 1 "/home/rudy/opt/FreedomStudio/SiFive/riscv64-unknown-elf-gcc-8.3.0-2020.04.1/lib/gcc/riscv64-unknown-elf/8.3.0/include/stddef.h" 1 3 4
...
# 60 "/home/rudy/opt/FreedomStudio/SiFive/riscv64-unknown-elf-gcc-8.3.0-2020.04.1/riscv64-unknown-elf/include/stdio.h" 3
...
# 61 "/home/rudy/opt/FreedomStudio/SiFive/riscv64-unknown-elf-gcc-8.3.0-2020.04.1/riscv64-unknown-elf/include/stdio.h" 2 3
...
# 62 "/home/rudy/opt/FreedomStudio/SiFive/riscv64-unknown-elf-gcc-8.3.0-2020.04.1/riscv64-unknown-elf/include/stdio.h" 2 3
...
# 3 "freedom-e-sdk/bsp/env/freedom-e300-hifive1/init.c" 2
...
# 4 "freedom-e-sdk/bsp/env/freedom-e300-hifive1/init.c" 2
...
# 6 "freedom-e-sdk/bsp/env/freedom-e300-hifive1/init.c" 2
...
# 7 "freedom-e-sdk/bsp/env/freedom-e300-hifive1/init.c" 2
...
{
  return *(volatile unsigned long *)((0x02000000UL) + 0xBFF8);
}
# 35 "freedom-e-sdk/bsp/env/freedom-e300-hifive1/init.c"
...
static void use_hfrosc(int div, int trim)
{
  ...
  (*(volatile uint32_t *) (((0x10008000UL)) + ((0x0000)))) = ((((div) & 0x2F) << 0 ) | (((trim) & 0x1F) << 16) | (((1) & 0x1 ) << 30));
  while (((*(volatile uint32_t *) (((0x10008000UL)) + ((0x0000)))) & (((1) & 0x1 ) << 31)) == 0) ;
  (*(volatile uint32_t *) (((0x10008000UL)) + ((0x0008)))) &= ~(((1) & 0x1) << 16);
}

void use_pll(int refsel, int bypass, int r, int f, int q)
{

  if ((*(volatile uint32_t *) (((0x10008000UL)) + ((0x0008)))) & (((1) & 0x1) << 16)) {
  ...
  config_value |= (((refsel) & 0x1) << 17);

  if (bypass) {

    config_value |= (((1) & 0x1) << 18);

    (*(volatile uint32_t *) (((0x10008000UL)) + ((0x0008)))) = config_value;



    (*(volatile uint32_t *) (((0x10008000UL)) + ((0x000C)))) = ((((1) & 0x1 ) << 8) | (((0) & 0x3F) << 0));
  } else {
    ...
    (*(volatile uint32_t *) (((0x10014000UL)) + (0x00))) = 8;
# 95 "freedom-e-sdk/bsp/env/freedom-e300-hifive1/init.c"
    config_value |= (((1) & 0x1) << 18);
    config_value |= (((r) & 0x7) << 0);





    config_value |= (((f) & 0x3F) << 4);



    config_value |= (((q) & 0x3) << 10);
    ...
    (*(volatile uint32_t *) (((0x10008000UL)) + ((0x0008)))) &= ~(((1) & 0x1) << 18);
    ...
    while (((*(volatile uint32_t *) (((0x10008000UL)) + ((0x0008)))) & (((1) & 0x1) << 31)) == 0) ;
  }
...
void use_default_clocks()
{
  ...
  (*(volatile uint32_t *) (((0x10000000UL)) + (0x070))) &= ~(((1) & 0x1 ) << 30);
...
static unsigned long __attribute__((noinline)) measure_cpu_freq(size_t n)
{
  ...
  unsigned long start_mcycle = ({ unsigned long __tmp; asm volatile ("csrr %0, " "mcycle" : "=r"(__tmp)); __tmp; });

  do {
    delta_mtime = mtime_lo() - start_mtime;
  } while (delta_mtime < n);

  unsigned long delta_mcycle = ({ unsigned long __tmp; asm volatile ("csrr %0, " "mcycle" : "=r"(__tmp)); __tmp; }) - start_mcycle;
...
{
  (*(volatile uint32_t *) (((0x10012000UL)) + ((0x3C)))) &= ~(0x00030000UL);
  (*(volatile uint32_t *) (((0x10012000UL)) + ((0x38)))) |= (0x00030000UL);
  (*(volatile uint32_t *) (((0x10013000UL)) + (0x18))) = get_cpu_freq() / baud_rate - 1;
  (*(volatile uint32_t *) (((0x10013000UL)) + (0x08))) |= 0x1;
}
...
uintptr_t handle_trap(uintptr_t mcause, uintptr_t epc)
{
  ...
  } else if ((mcause & 0x80000000) && ((mcause & 0x7FFFFFFF) == 7)){
...
void _init()
{
# 233 "freedom-e-sdk/bsp/env/freedom-e300-hifive1/init.c"
}
