# 1 "/home/rudy/workspace/Projects/rt-thread/src/device.c"
...
# 1 "/home/rudy/workspace/Projects/rt-thread/src/device.c"
# 17 "/home/rudy/workspace/Projects/rt-thread/src/device.c"
...
# 18 "/home/rudy/workspace/Projects/rt-thread/src/device.c" 2
# 32 "/home/rudy/workspace/Projects/rt-thread/src/device.c"
...
# 49 "/home/rudy/workspace/Projects/rt-thread/src/device.c"
rt_err_t rt_device_register(rt_device_t dev,
                            const char *name,
                            rt_uint16_t flags)
{
...
;
# 80 "/home/rudy/workspace/Projects/rt-thread/src/device.c"
rt_err_t rt_device_unregister(rt_device_t dev)
{
    if (!(dev != (0))) { rt_assert_handler("dev != RT_NULL", __FUNCTION__, 82); };
    if (!(rt_object_get_type(&dev->parent) == RT_Object_Class_Device)) { rt_assert_handler("rt_object_get_type(&dev->parent) == RT_Object_Class_Device", __FUNCTION__, 83); };
    if (!(rt_object_is_systemobject(&dev->parent))) { rt_assert_handler("rt_object_is_systemobject(&dev->parent)", __FUNCTION__, 84); };
...
;
# 100 "/home/rudy/workspace/Projects/rt-thread/src/device.c"
rt_err_t rt_device_init_all(void)
{
    return 0;
}
# 112 "/home/rudy/workspace/Projects/rt-thread/src/device.c"
rt_device_t rt_device_find(const char *name)
{
    ...
    if (!(information != (0))) { rt_assert_handler("information != RT_NULL", __FUNCTION__, 124); };
...
;
# 158 "/home/rudy/workspace/Projects/rt-thread/src/device.c"
rt_device_t rt_device_create(int type, int attach_size)
{
    int size;
    rt_device_t device;
...
{
    if (!(dev != (0))) { rt_assert_handler("dev != RT_NULL", __FUNCTION__, 186); };
    if (!(rt_object_get_type(&dev->parent) == RT_Object_Class_Device)) { rt_assert_handler("rt_object_get_type(&dev->parent) == RT_Object_Class_Device", __FUNCTION__, 187); };
    if (!(rt_object_is_systemobject(&dev->parent) == 0)) { rt_assert_handler("rt_object_is_systemobject(&dev->parent) == RT_FALSE", __FUNCTION__, 188); };
...
;
# 205 "/home/rudy/workspace/Projects/rt-thread/src/device.c"
rt_err_t rt_device_init(rt_device_t dev)
{
    rt_err_t result = 0;

    if (!(dev != (0))) { rt_assert_handler("dev != RT_NULL", __FUNCTION__, 209); };
...
# 240 "/home/rudy/workspace/Projects/rt-thread/src/device.c"
rt_err_t rt_device_open(rt_device_t dev, rt_uint16_t oflag)
{
    rt_err_t result = 0;

    if (!(dev != (0))) { rt_assert_handler("dev != RT_NULL", __FUNCTION__, 244); };
    if (!(rt_object_get_type(&dev->parent) == RT_Object_Class_Device)) { rt_assert_handler("rt_object_get_type(&dev->parent) == RT_Object_Class_Device", __FUNCTION__, 245); };
    ...
    if (result == 0 || result == -6)
    {
        ...
        if (!(dev->ref_count != 0)) { rt_assert_handler("dev->ref_count != 0", __FUNCTION__, 291); };
    }

    return result;
}
;
# 305 "/home/rudy/workspace/Projects/rt-thread/src/device.c"
rt_err_t rt_device_close(rt_device_t dev)
{
    rt_err_t result = 0;

    if (!(dev != (0))) { rt_assert_handler("dev != RT_NULL", __FUNCTION__, 309); };
    if (!(rt_object_get_type(&dev->parent) == RT_Object_Class_Device)) { rt_assert_handler("rt_object_get_type(&dev->parent) == RT_Object_Class_Device", __FUNCTION__, 310); };
...
;
# 346 "/home/rudy/workspace/Projects/rt-thread/src/device.c"
rt_size_t rt_device_read(rt_device_t dev,
                         rt_off_t pos,
                         void *buffer,
                         rt_size_t size)
{
    if (!(dev != (0))) { rt_assert_handler("dev != RT_NULL", __FUNCTION__, 351); };
    if (!(rt_object_get_type(&dev->parent) == RT_Object_Class_Device)) { rt_assert_handler("rt_object_get_type(&dev->parent) == RT_Object_Class_Device", __FUNCTION__, 352); };
...
;
# 385 "/home/rudy/workspace/Projects/rt-thread/src/device.c"
rt_size_t rt_device_write(rt_device_t dev,
                          rt_off_t pos,
                          const void *buffer,
                          rt_size_t size)
{
    if (!(dev != (0))) { rt_assert_handler("dev != RT_NULL", __FUNCTION__, 390); };
    if (!(rt_object_get_type(&dev->parent) == RT_Object_Class_Device)) { rt_assert_handler("rt_object_get_type(&dev->parent) == RT_Object_Class_Device", __FUNCTION__, 391); };
...
;
# 421 "/home/rudy/workspace/Projects/rt-thread/src/device.c"
rt_err_t rt_device_control(rt_device_t dev, int cmd, void *arg)
{
    if (!(dev != (0))) { rt_assert_handler("dev != RT_NULL", __FUNCTION__, 423); };
    if (!(rt_object_get_type(&dev->parent) == RT_Object_Class_Device)) { rt_assert_handler("rt_object_get_type(&dev->parent) == RT_Object_Class_Device", __FUNCTION__, 424); };
...
;
# 445 "/home/rudy/workspace/Projects/rt-thread/src/device.c"
rt_err_t
rt_device_set_rx_indicate(rt_device_t dev,
                          rt_err_t (*rx_ind)(rt_device_t dev, rt_size_t size))
{
    if (!(dev != (0))) { rt_assert_handler("dev != RT_NULL", __FUNCTION__, 449); };
    if (!(rt_object_get_type(&dev->parent) == RT_Object_Class_Device)) { rt_assert_handler("rt_object_get_type(&dev->parent) == RT_Object_Class_Device", __FUNCTION__, 450); };
...
;
# 467 "/home/rudy/workspace/Projects/rt-thread/src/device.c"
rt_err_t
rt_device_set_tx_complete(rt_device_t dev,
                          rt_err_t (*tx_done)(rt_device_t dev, void *buffer))
{
    if (!(dev != (0))) { rt_assert_handler("dev != RT_NULL", __FUNCTION__, 471); };
    if (!(rt_object_get_type(&dev->parent) == RT_Object_Class_Device)) { rt_assert_handler("rt_object_get_type(&dev->parent) == RT_Object_Class_Device", __FUNCTION__, 472); };
