...
.LFB15:
	.file 2 "/home/rudy/workspace/Projects/rt-thread/src/scheduler.c"
	.loc 2 69 1
	.cfi_startproc
	addi	sp,sp,-32
	.cfi_def_cfa_offset 32
...
.LC1:
	...
	.align	2
.LC2:
	.string	"warning: %s stack is close to end of stack address.\n"
	.text
	.align	1
	.type	_rt_scheduler_stack_check, @function
...
.LFB16:
	...
	lw	a5,-36(s0)
	bne	a5,zero,.L8
	.loc 2 79 29 discriminator 1
	li	a2,79
	lla	a1,__FUNCTION__.3086
	lla	a0,.LC0
...
.L8:
	...
	li	a5,35
	bne	a4,a5,.L9
	.loc 2 86 27 discriminator 1
	lw	a5,-36(s0)
	lw	a5,52(a5)
	.loc 2 86 9 discriminator 1
	mv	a4,a5
	.loc 2 86 53 discriminator 1
	lw	a5,-36(s0)
	lw	a5,64(a5)
...
.L14:
	...
	.cfi_endproc
.LFE16:
	.size	_rt_scheduler_stack_check, .-_rt_scheduler_stack_check
	.align	1
	.type	_get_highest_priority_thread, @function
...
.LFB17:
	...
	.cfi_endproc
.LFE17:
	.size	_get_highest_priority_thread, .-_get_highest_priority_thread
	.align	1
...
.LFB18:
	...
	j	.L18
.L19:
	.loc 2 203 9 discriminator 3
	slli	a4,s1,3
	lla	a5,rt_thread_priority_table
	add	a5,a4,a5
	mv	a0,a5
	call	rt_list_init
	.loc 2 201 43 discriminator 3
	addi	s1,s1,1
.L18:
	.loc 2 201 5 discriminator 1
	li	a5,255
	ble	s1,a5,.L19
	.loc 2 226 36
	lla	a5,rt_thread_ready_priority_group
...
.L25:
	...
	.loc 2 441 25
	bne	a4,a5,.L27
	.loc 2 441 109 discriminator 1
	lla	a5,rt_current_thread
	lw	a5,0(a5)
	lbu	a5,76(a5)
	.loc 2 441 116 discriminator 1
	andi	a5,a5,8
	.loc 2 441 88 discriminator 1
	bne	a5,zero,.L27
	.loc 2 443 31
	lla	a5,rt_current_thread
	lw	a5,0(a5)
...
.L30:
	...
	.loc 2 479 17
	lw	a0,-20(s0)
	call	_rt_scheduler_stack_check
	.loc 2 482 39
...
.LFB22:
	...
	lw	a5,-20(s0)
	bne	a5,zero,.L39
	.loc 2 805 29 discriminator 1
	li	a2,805
	lla	a1,__FUNCTION__.3134
	lla	a0,.LC0
	call	rt_assert_handler
.L39:
	.loc 2 808 13
...
.LFE25:
	...
	.size	__FUNCTION__.3086, 26
__FUNCTION__.3086:
	.string	"_rt_scheduler_stack_check"
	.align	2
	.type	__FUNCTION__.3128, @object
	.size	__FUNCTION__.3128, 26
__FUNCTION__.3128:
	.string	"rt_schedule_insert_thread"
	.align	2
	.type	__FUNCTION__.3134, @object
	.size	__FUNCTION__.3134, 26
__FUNCTION__.3134:
...
.LASF1900:
	.string	"/home/rudy/workspace/Projects/rt-thread/src/scheduler.c"
.LASF331:
...
.LASF1894:
	.string	"_get_highest_priority_thread"
.LASF330:
