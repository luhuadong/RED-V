# 1 "/home/rudy/workspace/Projects/rt-thread/src/mempool.c"
...
# 1 "/home/rudy/workspace/Projects/rt-thread/src/mempool.c"
# 19 "/home/rudy/workspace/Projects/rt-thread/src/mempool.c"
...
# 20 "/home/rudy/workspace/Projects/rt-thread/src/mempool.c" 2
...
# 40 "/home/rudy/workspace/Projects/rt-thread/src/mempool.c"
void rt_mp_alloc_sethook(void (*hook)(struct rt_mempool *mp, void *block))
{
...
# 77 "/home/rudy/workspace/Projects/rt-thread/src/mempool.c"
rt_err_t rt_mp_init(struct rt_mempool *mp,
                    const char *name,
                    void *start,
                    rt_size_t size,
                    rt_size_t block_size)
{
    ...
    if (!(mp != (0))) { rt_assert_handler("mp != RT_NULL", __FUNCTION__, 87); };
    if (!(name != (0))) { rt_assert_handler("name != RT_NULL", __FUNCTION__, 88); };
    if (!(start != (0))) { rt_assert_handler("start != RT_NULL", __FUNCTION__, 89); };
    if (!(size > 0 && block_size > 0)) { rt_assert_handler("size > 0 && block_size > 0", __FUNCTION__, 90); };
...
;
# 134 "/home/rudy/workspace/Projects/rt-thread/src/mempool.c"
rt_err_t rt_mp_detach(struct rt_mempool *mp)
{
    ...
    if (!(mp != (0))) { rt_assert_handler("mp != RT_NULL", __FUNCTION__, 140); };
    if (!(rt_object_get_type(&mp->parent) == RT_Object_Class_MemPool)) { rt_assert_handler("rt_object_get_type(&mp->parent) == RT_Object_Class_MemPool", __FUNCTION__, 141); };
    if (!(rt_object_is_systemobject(&mp->parent))) { rt_assert_handler("rt_object_is_systemobject(&mp->parent)", __FUNCTION__, 142); };
...
;
# 184 "/home/rudy/workspace/Projects/rt-thread/src/mempool.c"
rt_mp_t rt_mp_create(const char *name,
                     rt_size_t block_count,
                     rt_size_t block_size)
{
    ...
    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 192); } } rt_hw_interrupt_enable(level); } while (0);


    if (!(name != (0))) { rt_assert_handler("name != RT_NULL", __FUNCTION__, 195); };
    if (!(block_count > 0 && block_size > 0)) { rt_assert_handler("block_count > 0 && block_size > 0", __FUNCTION__, 196); };
...
;
# 250 "/home/rudy/workspace/Projects/rt-thread/src/mempool.c"
rt_err_t rt_mp_delete(rt_mp_t mp)
{
    struct rt_thread *thread;
    register rt_ubase_t level;

    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 255); } } rt_hw_interrupt_enable(level); } while (0);


    if (!(mp != (0))) { rt_assert_handler("mp != RT_NULL", __FUNCTION__, 258); };
    if (!(rt_object_get_type(&mp->parent) == RT_Object_Class_MemPool)) { rt_assert_handler("rt_object_get_type(&mp->parent) == RT_Object_Class_MemPool", __FUNCTION__, 259); };
    if (!(rt_object_is_systemobject(&mp->parent) == 0)) { rt_assert_handler("rt_object_is_systemobject(&mp->parent) == RT_FALSE", __FUNCTION__, 260); };
...
;
# 303 "/home/rudy/workspace/Projects/rt-thread/src/mempool.c"
void *rt_mp_alloc(rt_mp_t mp, rt_int32_t time)
{
    rt_uint8_t *block_ptr;
    ...
    if (!(mp != (0))) { rt_assert_handler("mp != RT_NULL", __FUNCTION__, 311); };
    ...
    while (mp->block_free_count == 0)
    {
        ...
        do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 332); } } rt_hw_interrupt_enable(level); } while (0);
    ...
    if (!(block_ptr != (0))) { rt_assert_handler("block_ptr != RT_NULL", __FUNCTION__, 376); };
