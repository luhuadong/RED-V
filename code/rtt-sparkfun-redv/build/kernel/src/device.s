...
rt_device_register:
.LFB15:
	.file 1 "/home/rudy/workspace/Projects/rt-thread/src/device.c"
	.loc 1 52 1
	.cfi_startproc
	addi	sp,sp,-32
...
.LC0:
	...
	.align	2
.LC1:
	.string	"rt_object_get_type(&dev->parent) == RT_Object_Class_Device"
	.align	2
.LC2:
	.string	"rt_object_is_systemobject(&dev->parent)"
	.text
	.align	1
...
.L13:
	...
	lw	a5,-24(s0)
	bne	a5,zero,.L14
	.loc 1 124 34 discriminator 1
	li	a2,124
	lla	a1,__FUNCTION__.3011
	lla	a0,.LC3
	call	rt_assert_handler
.L14:
	.loc 1 125 15
...
.LFE19:
	...
	.align	2
.LC4:
	.string	"rt_object_is_systemobject(&dev->parent) == RT_FALSE"
	.text
	.align	1
...
.LFB23:
	...
	lw	a5,-36(s0)
	bne	a5,zero,.L45
	.loc 1 309 26 discriminator 1
	li	a2,309
	lla	a1,__FUNCTION__.3040
	lla	a0,.LC0
	call	rt_assert_handler
.L45:
	.loc 1 310 11
...
.LFB25:
	...
	lw	a5,-20(s0)
	bne	a5,zero,.L60
	.loc 1 390 26 discriminator 1
	li	a2,390
	lla	a1,__FUNCTION__.3054
	lla	a0,.LC0
	call	rt_assert_handler
.L60:
	.loc 1 391 11
...
.LFB26:
	...
	lw	a5,-20(s0)
	bne	a5,zero,.L66
	.loc 1 423 26 discriminator 1
	li	a2,423
	lla	a1,__FUNCTION__.3060
	lla	a0,.LC0
	call	rt_assert_handler
.L66:
	.loc 1 424 11
...
.LFE28:
	...
	.section	.rodata
	.align	2
	.type	__FUNCTION__.3001, @object
	.size	__FUNCTION__.3001, 21
__FUNCTION__.3001:
	.string	"rt_device_unregister"
	.align	2
	.type	__FUNCTION__.3011, @object
	.size	__FUNCTION__.3011, 15
__FUNCTION__.3011:
	.string	"rt_device_find"
	.align	2
	.type	__FUNCTION__.3024, @object
	.size	__FUNCTION__.3024, 18
__FUNCTION__.3024:
	.string	"rt_device_destroy"
	.align	2
	.type	__FUNCTION__.3029, @object
	.size	__FUNCTION__.3029, 15
__FUNCTION__.3029:
	.string	"rt_device_init"
	.align	2
	.type	__FUNCTION__.3035, @object
	.size	__FUNCTION__.3035, 15
__FUNCTION__.3035:
	.string	"rt_device_open"
	.align	2
	.type	__FUNCTION__.3040, @object
	.size	__FUNCTION__.3040, 16
__FUNCTION__.3040:
	.string	"rt_device_close"
	.align	2
	.type	__FUNCTION__.3047, @object
	.size	__FUNCTION__.3047, 15
__FUNCTION__.3047:
	.string	"rt_device_read"
	.align	2
	.type	__FUNCTION__.3054, @object
	.size	__FUNCTION__.3054, 16
__FUNCTION__.3054:
	.string	"rt_device_write"
	.align	2
	.type	__FUNCTION__.3060, @object
	.size	__FUNCTION__.3060, 18
__FUNCTION__.3060:
	.string	"rt_device_control"
	.align	2
	.type	__FUNCTION__.3067, @object
	.size	__FUNCTION__.3067, 26
__FUNCTION__.3067:
	.string	"rt_device_set_rx_indicate"
	.align	2
	.type	__FUNCTION__.3074, @object
	.size	__FUNCTION__.3074, 26
__FUNCTION__.3074:
...
.LASF1916:
	.string	"/home/rudy/workspace/Projects/rt-thread/src/device.c"
.LASF1567:
	.string	"SIGXFSZ 25"
.LASF980:
