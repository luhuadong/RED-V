...
.LFE4:
	...
	.local	rt_mp_alloc_hook
	.comm	rt_mp_alloc_hook,4,4
	.local	rt_mp_free_hook
	.comm	rt_mp_free_hook,4,4
	.align	1
	.globl	rt_mp_alloc_sethook
	.type	rt_mp_alloc_sethook, @function
rt_mp_alloc_sethook:
.LFB15:
	.file 2 "/home/rudy/workspace/Projects/rt-thread/src/mempool.c"
	.loc 2 41 1
	.cfi_startproc
	addi	sp,sp,-32
	.cfi_def_cfa_offset 32
...
.LC1:
	...
	.align	2
.LC2:
	.string	"start != RT_NULL"
	.align	2
.LC3:
	.string	"size > 0 && block_size > 0"
	.text
	.align	1
	.globl	rt_mp_init
...
.LFB17:
	...
	lw	a5,-36(s0)
	bne	a5,zero,.L8
	.loc 2 87 25 discriminator 1
	li	a2,87
	lla	a1,__FUNCTION__.3092
	lla	a0,.LC0
...
.L12:
	...
	j	.L13
.L14:
	.loc 2 115 48 discriminator 3
	addi	a4,s1,1
	.loc 2 115 67 discriminator 3
	lw	a5,-52(s0)
	addi	a5,a5,4
	.loc 2 115 53 discriminator 3
	mul	a4,a4,a5
	.loc 2 114 59 discriminator 3
	lw	a5,-52(s0)
	addi	a5,a5,4
	.loc 2 114 45 discriminator 3
	mul	a5,s1,a5
	.loc 2 114 36 discriminator 3
	lw	a3,-20(s0)
	add	a5,a3,a5
	.loc 2 115 13 discriminator 3
	lw	a3,-20(s0)
	add	a4,a3,a4
	.loc 2 114 84 discriminator 3
	sw	a4,0(a5)
	.loc 2 112 61 discriminator 3
	addi	s1,s1,1
.L13:
	.loc 2 112 33 discriminator 1
	lw	a5,-36(s0)
	lw	a5,60(a5)
	.loc 2 112 5 discriminator 1
	bltu	s1,a5,.L14
	.loc 2 118 42
	addi	a4,s1,-1
	.loc 2 118 61
...
.LFE17:
	...
	.align	2
.LC4:
	.string	"rt_object_get_type(&mp->parent) == RT_Object_Class_MemPool"
	.align	2
.LC5:
	.string	"rt_object_is_systemobject(&mp->parent)"
	.text
	.align	1
	.globl	rt_mp_detach
...
.LC7:
	...
	.align	2
.LC8:
	.string	"block_count > 0 && block_size > 0"
	.text
	.align	1
	.globl	rt_mp_create
...
.LBB2:
	...
	.loc 2 192 65
	beq	a5,zero,.L24
	.loc 2 192 98 discriminator 1
	lla	a1,__FUNCTION__.3114
	lla	a0,.LC6
	call	rt_kprintf
	.loc 2 192 179 discriminator 1
	li	a2,192
	lla	a1,__FUNCTION__.3114
	lla	a0,.LC7
	call	rt_assert_handler
.L24:
	.loc 2 192 226 discriminator 5
	lw	a0,-20(s0)
	call	rt_hw_interrupt_enable
.LBE2:
	.loc 2 195 8 discriminator 5
	lw	a5,-36(s0)
	bne	a5,zero,.L25
...
.L25:
	...
	lw	a5,-40(s0)
	beq	a5,zero,.L26
	.loc 2 196 9 discriminator 2
	lw	a5,-44(s0)
	bne	a5,zero,.L27
.L26:
	.loc 2 196 49 discriminator 3
	li	a2,196
	lla	a1,__FUNCTION__.3114
	lla	a0,.LC8
	call	rt_assert_handler
...
.L30:
	...
	j	.L31
.L32:
	.loc 2 231 35 discriminator 3
	addi	a4,s1,1
	.loc 2 231 54 discriminator 3
	lw	a5,-44(s0)
	addi	a5,a5,4
	.loc 2 231 40 discriminator 3
	mul	a4,a4,a5
	.loc 2 230 59 discriminator 3
	lw	a5,-44(s0)
	addi	a5,a5,4
	.loc 2 230 45 discriminator 3
	mul	a5,s1,a5
	.loc 2 230 36 discriminator 3
	lw	a3,-28(s0)
	add	a5,a3,a5
	.loc 2 231 25 discriminator 3
	lw	a3,-28(s0)
	add	a4,a3,a4
	.loc 2 231 13 discriminator 3
	sw	a4,0(a5)
	.loc 2 228 61 discriminator 3
	addi	s1,s1,1
.L31:
	.loc 2 228 33 discriminator 1
	lw	a5,-24(s0)
	lw	a5,60(a5)
...
.LFE19:
	...
	.align	2
.LC9:
	.string	"rt_object_is_systemobject(&mp->parent) == RT_FALSE"
	.text
	.align	1
	.globl	rt_mp_delete
...
.LBB3:
	...
	.loc 2 255 65
	beq	a5,zero,.L34
	.loc 2 255 98 discriminator 1
	lla	a1,__FUNCTION__.3124
	lla	a0,.LC6
	call	rt_kprintf
	.loc 2 255 179 discriminator 1
	li	a2,255
	lla	a1,__FUNCTION__.3124
	lla	a0,.LC7
	call	rt_assert_handler
.L34:
	.loc 2 255 226 discriminator 5
	lw	a0,-20(s0)
	call	rt_hw_interrupt_enable
.LBE3:
	.loc 2 258 8 discriminator 5
	lw	a5,-36(s0)
	bne	a5,zero,.L35
	.loc 2 258 25 discriminator 1
	li	a2,258
	lla	a1,__FUNCTION__.3124
	lla	a0,.LC0
	call	rt_assert_handler
...
.L36:
	...
	.loc 2 260 8
	beq	a5,zero,.L38
	.loc 2 260 59 discriminator 1
	li	a2,260
	lla	a1,__FUNCTION__.3124
	lla	a0,.LC9
	call	rt_assert_handler
	.loc 2 263 11 discriminator 1
	j	.L38
.L39:
	.loc 2 266 17
	call	rt_hw_interrupt_disable
...
.LBB4:
	...
	.loc 2 332 69
	beq	a5,zero,.L46
	.loc 2 332 102 discriminator 1
	lla	a1,__FUNCTION__.3136
	lla	a0,.LC6
	call	rt_kprintf
	.loc 2 332 183 discriminator 1
	li	a2,332
	lla	a1,__FUNCTION__.3136
	lla	a0,.LC7
	call	rt_assert_handler
.L46:
	.loc 2 332 230 discriminator 5
	lw	a0,-28(s0)
	call	rt_hw_interrupt_enable
.LBE4:
	.loc 2 334 23 discriminator 5
	lw	a5,-24(s0)
	sw	zero,72(a5)
	.loc 2 337 9 discriminator 5
	lw	a0,-24(s0)
	call	rt_thread_suspend
	.loc 2 338 9 discriminator 5
	lw	a5,-36(s0)
	addi	a4,a5,68
	lw	a5,-24(s0)
	addi	a5,a5,44
	...
	.loc 2 340 18 discriminator 5
	lw	a5,-40(s0)
	.loc 2 340 12 discriminator 5
	ble	a5,zero,.L47
	.loc 2 343 28
	call	rt_tick_get
	sw	a0,-20(s0)
...
.L51:
	...
	.loc 2 387 13
	beq	a5,zero,.L52
	.loc 2 387 41 discriminator 1
	lla	a5,rt_mp_alloc_hook
	lw	a4,0(a5)
	.loc 2 387 63 discriminator 1
	lw	a5,-32(s0)
	addi	a5,a5,4
	.loc 2 387 41 discriminator 1
	mv	a1,a5
...
.LFE22:
	...
	.section	.rodata
	.align	2
	.type	__FUNCTION__.3092, @object
	.size	__FUNCTION__.3092, 11
__FUNCTION__.3092:
	.string	"rt_mp_init"
	.align	2
	.type	__FUNCTION__.3101, @object
	.size	__FUNCTION__.3101, 13
__FUNCTION__.3101:
	.string	"rt_mp_detach"
	.align	2
	.type	__FUNCTION__.3114, @object
	.size	__FUNCTION__.3114, 13
__FUNCTION__.3114:
	.string	"rt_mp_create"
	.align	2
	.type	__FUNCTION__.3124, @object
	.size	__FUNCTION__.3124, 13
__FUNCTION__.3124:
	.string	"rt_mp_delete"
	.align	2
	.type	__FUNCTION__.3136, @object
	.size	__FUNCTION__.3136, 12
__FUNCTION__.3136:
	.string	"rt_mp_alloc"
	.text
.Letext0:
...
.LASF1907:
	.string	"/home/rudy/workspace/Projects/rt-thread/src/mempool.c"
.LASF697:
