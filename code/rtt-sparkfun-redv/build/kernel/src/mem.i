# 1 "/home/rudy/workspace/Projects/rt-thread/src/mem.c"
...
# 1 "/home/rudy/workspace/Projects/rt-thread/src/mem.c"
# 50 "/home/rudy/workspace/Projects/rt-thread/src/mem.c"
...
# 51 "/home/rudy/workspace/Projects/rt-thread/src/mem.c" 2
...
# 75 "/home/rudy/workspace/Projects/rt-thread/src/mem.c"
void rt_malloc_sethook(void (*hook)(void *ptr, rt_size_t size))
{
    rt_malloc_hook = hook;
}
...
static __inline void rt_mem_setname(struct heap_mem *mem, const char *name)
{
    int index;
...
static void plug_holes(struct heap_mem *mem)
{
    ...
    if (!((rt_uint8_t *)mem >= heap_ptr)) { rt_assert_handler("(rt_uint8_t *)mem >= heap_ptr", __FUNCTION__, 161); };
    if (!((rt_uint8_t *)mem < (rt_uint8_t *)heap_end)) { rt_assert_handler("(rt_uint8_t *)mem < (rt_uint8_t *)heap_end", __FUNCTION__, 162); };
    if (!(mem->used == 0)) { rt_assert_handler("mem->used == 0", __FUNCTION__, 163); };
...
# 204 "/home/rudy/workspace/Projects/rt-thread/src/mem.c"
void rt_system_heap_init(void *begin_addr, void *end_addr)
{
    struct heap_mem *mem;
    rt_ubase_t begin_align = ((((rt_ubase_t)begin_addr) + (4) - 1) & ~((4) - 1));
    rt_ubase_t end_align = (((rt_ubase_t)end_addr) & ~((4) - 1));

    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 210); } } rt_hw_interrupt_enable(level); } while (0);
...
# 272 "/home/rudy/workspace/Projects/rt-thread/src/mem.c"
void *rt_malloc(rt_size_t size)
{
         ...
         ptr = ((struct heap_mem *)&heap_ptr[ptr])->next)
    {
        ...
        if ((!mem->used) && (mem->next - (ptr + (((sizeof(struct heap_mem)) + (4) - 1) & ~((4) - 1)))) >= size)
        {
            ...
            {
# 329 "/home/rudy/workspace/Projects/rt-thread/src/mem.c"
            ...
            if (mem == lfree)
            {
                ...
                if (!(((lfree == heap_end) || (!lfree->used)))) { rt_assert_handler("((lfree == heap_end) || (!lfree->used))", __FUNCTION__, 386); };
            }

            rt_sem_release(&heap_sem);
            if (!((rt_ubase_t)mem + (((sizeof(struct heap_mem)) + (4) - 1) & ~((4) - 1)) + size <= (rt_ubase_t)heap_end)) { rt_assert_handler("(rt_ubase_t)mem + SIZEOF_STRUCT_MEM + size <= (rt_ubase_t)heap_end", __FUNCTION__, 390); };
            if (!((rt_ubase_t)((rt_uint8_t *)mem + (((sizeof(struct heap_mem)) + (4) - 1) & ~((4) - 1))) % 4 == 0)) { rt_assert_handler("(rt_ubase_t)((rt_uint8_t *)mem + SIZEOF_STRUCT_MEM) % RT_ALIGN_SIZE == 0", __FUNCTION__, 391); };
            if (!((((rt_ubase_t)mem) & (4 - 1)) == 0)) { rt_assert_handler("(((rt_ubase_t)mem) & (RT_ALIGN_SIZE - 1)) == 0", __FUNCTION__, 392); };

            do { if (0) rt_kprintf ("allocate memory at 0x%x, size: %d\n", (rt_ubase_t)((rt_uint8_t *)mem + (((sizeof(struct heap_mem)) + (4) - 1) & ~((4) - 1))), (rt_ubase_t)(mem->next - ((rt_uint8_t *)mem - heap_ptr))); } while (0)
...
;
# 421 "/home/rudy/workspace/Projects/rt-thread/src/mem.c"
void *rt_realloc(void *rmem, rt_size_t newsize)
{
    ...
    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 428); } } rt_hw_interrupt_enable(level); } while (0);
...
;
# 531 "/home/rudy/workspace/Projects/rt-thread/src/mem.c"
void *rt_calloc(rt_size_t count, rt_size_t size)
{
    void *p;
...
void rt_free(void *rmem)
{
    ...
    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 559); } } rt_hw_interrupt_enable(level); } while (0);

    if (!((((rt_ubase_t)rmem) & (4 - 1)) == 0)) { rt_assert_handler("(((rt_ubase_t)rmem) & (RT_ALIGN_SIZE - 1)) == 0", __FUNCTION__, 561); };
    if (!((rt_uint8_t *)rmem >= (rt_uint8_t *)heap_ptr && (rt_uint8_t *)rmem < (rt_uint8_t *)heap_end)) { rt_assert_handler("(rt_uint8_t *)rmem >= (rt_uint8_t *)heap_ptr && (rt_uint8_t *)rmem < (rt_uint8_t *)heap_end", __FUNCTION__,
                                                         563
# 562 "/home/rudy/workspace/Projects/rt-thread/src/mem.c"
    ); }
                                                          ;
    ...
    do { if (0) rt_kprintf ("release memory 0x%x, size: %d\n", (rt_ubase_t)rmem, (rt_ubase_t)(mem->next - ((rt_uint8_t *)mem - heap_ptr))); } while (0)
    ...
    if (!(mem->used)) { rt_assert_handler("mem->used", __FUNCTION__, 593); };
    if (!(mem->magic == 0x1ea0)) { rt_assert_handler("mem->magic == HEAP_MAGIC", __FUNCTION__, 594); };
...
# 633 "/home/rudy/workspace/Projects/rt-thread/src/mem.c" 2
...
const char __fsym_list_mem_name[] __attribute__((section(".rodata.name"))) = "list_mem"; const char __fsym_list_mem_desc[] __attribute__((section(".rodata.name"))) = "list memory usage information"; __attribute__((used)) const struct finsh_syscall __fsym_list_mem __attribute__((section("FSymTab")))= { __fsym_list_mem_name, __fsym_list_mem_desc, (syscall_func)&list_mem };
...
int memcheck(void)
{
    ...
    for (mem = (struct heap_mem *)heap_ptr; mem != heap_end; mem = (struct heap_mem *)&heap_ptr[mem->next])
    {
        ...
        if (mem->magic != 0x1ea0) goto __exit;
...
__exit:
    ...
    rt_kprintf("   used: %d\n", mem->used);
    rt_kprintf("  size: %d\n", mem->next - position - (((sizeof(struct heap_mem)) + (4) - 1) & ~((4) - 1)));
    rt_hw_interrupt_enable(level);

    return 0;
}
const char __fsym___cmd_memcheck_name[] __attribute__((section(".rodata.name"))) = "__cmd_memcheck"; const char __fsym___cmd_memcheck_desc[] __attribute__((section(".rodata.name"))) = "check memory data"; __attribute__((used)) const struct finsh_syscall __fsym___cmd_memcheck __attribute__((section("FSymTab")))= { __fsym___cmd_memcheck_name, __fsym___cmd_memcheck_desc, (syscall_func)&memcheck };;
...
int memtrace(int argc, char **argv)
{
    ...
    for (mem = (struct heap_mem *)heap_ptr; mem != heap_end; mem = (struct heap_mem *)&heap_ptr[mem->next])
    {
        ...
        size = mem->next - position - (((sizeof(struct heap_mem)) + (4) - 1) & ~((4) - 1));
        if (size < 1024)
            rt_kprintf("%5d", size);
...
const char __fsym___cmd_memtrace_name[] __attribute__((section(".rodata.name"))) = "__cmd_memtrace"; const char __fsym___cmd_memtrace_desc[] __attribute__((section(".rodata.name"))) = "dump memory trace information"; __attribute__((used)) const struct finsh_syscall __fsym___cmd_memtrace __attribute__((section("FSymTab")))= { __fsym___cmd_memtrace_name, __fsym___cmd_memtrace_desc, (syscall_func)&memtrace };;
