# 1 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
...
# 1 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
# 42 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
...
# 43 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c" 2
...
# 44 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c" 2


extern void (*rt_object_trytake_hook)(struct rt_object *object);
extern void (*rt_object_take_hook)(struct rt_object *object);
extern void (*rt_object_put_hook)(struct rt_object *object);
# 64 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
...
# 83 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
...
# 140 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
...
# 163 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
...
# 205 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_sem_init(rt_sem_t sem,
                     const char *name,
                     rt_uint32_t value,
                     rt_uint8_t flag)
{
    if (!(sem != (0))) { rt_assert_handler("sem != RT_NULL", __FUNCTION__, 210); };
    if (!(value < 0x10000U)) { rt_assert_handler("value < 0x10000U", __FUNCTION__, 211); };
...
;
# 238 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_sem_detach(rt_sem_t sem)
{

    if (!(sem != (0))) { rt_assert_handler("sem != RT_NULL", __FUNCTION__, 241); };
    if (!(rt_object_get_type(&sem->parent.parent) == RT_Object_Class_Semaphore)) { rt_assert_handler("rt_object_get_type(&sem->parent.parent) == RT_Object_Class_Semaphore", __FUNCTION__, 242); };
    if (!(rt_object_is_systemobject(&sem->parent.parent))) { rt_assert_handler("rt_object_is_systemobject(&sem->parent.parent)", __FUNCTION__, 243); };
...
;
# 267 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_sem_t rt_sem_create(const char *name, rt_uint32_t value, rt_uint8_t flag)
{
    rt_sem_t sem;

    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 271); } } rt_hw_interrupt_enable(level); } while (0);
    if (!(value < 0x10000U)) { rt_assert_handler("value < 0x10000U", __FUNCTION__, 272); };
...
;
# 301 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_sem_delete(rt_sem_t sem)
{
    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 303); } } rt_hw_interrupt_enable(level); } while (0);


    if (!(sem != (0))) { rt_assert_handler("sem != RT_NULL", __FUNCTION__, 306); };
    if (!(rt_object_get_type(&sem->parent.parent) == RT_Object_Class_Semaphore)) { rt_assert_handler("rt_object_get_type(&sem->parent.parent) == RT_Object_Class_Semaphore", __FUNCTION__, 307); };
    if (!(rt_object_is_systemobject(&sem->parent.parent) == 0)) { rt_assert_handler("rt_object_is_systemobject(&sem->parent.parent) == RT_FALSE", __FUNCTION__, 308); };
...
;
# 330 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_sem_take(rt_sem_t sem, rt_int32_t time)
{
    ...
    if (!(sem != (0))) { rt_assert_handler("sem != RT_NULL", __FUNCTION__, 336); };
    if (!(rt_object_get_type(&sem->parent.parent) == RT_Object_Class_Semaphore)) { rt_assert_handler("rt_object_get_type(&sem->parent.parent) == RT_Object_Class_Semaphore", __FUNCTION__, 337); };
    ...
    else
    {
        ...
        else
        {
            ...
            do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_thread_self() == (0)) { rt_kprintf("Function[%s] shall not be used before scheduler start\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 369); } } do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 369); } } rt_hw_interrupt_enable(level); } while (0); rt_hw_interrupt_enable(level); } while (0);
...
;
# 425 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_sem_trytake(rt_sem_t sem)
{
    return rt_sem_take(sem, 0);
}
;
# 439 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_sem_release(rt_sem_t sem)
{
    register rt_base_t temp;
    ...
    if (!(sem != (0))) { rt_assert_handler("sem != RT_NULL", __FUNCTION__, 445); };
    if (!(rt_object_get_type(&sem->parent.parent) == RT_Object_Class_Semaphore)) { rt_assert_handler("rt_object_get_type(&sem->parent.parent) == RT_Object_Class_Semaphore", __FUNCTION__, 446); };
...
;
# 499 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_sem_control(rt_sem_t sem, int cmd, void *arg)
{
    rt_ubase_t level;


    if (!(sem != (0))) { rt_assert_handler("sem != RT_NULL", __FUNCTION__, 504); };
    if (!(rt_object_get_type(&sem->parent.parent) == RT_Object_Class_Semaphore)) { rt_assert_handler("rt_object_get_type(&sem->parent.parent) == RT_Object_Class_Semaphore", __FUNCTION__, 505); };
...
;
# 546 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_mutex_init(rt_mutex_t mutex, const char *name, rt_uint8_t flag)
{

    if (!(mutex != (0))) { rt_assert_handler("mutex != RT_NULL", __FUNCTION__, 549); };
...
;
# 578 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_mutex_detach(rt_mutex_t mutex)
{

    if (!(mutex != (0))) { rt_assert_handler("mutex != RT_NULL", __FUNCTION__, 581); };
    if (!(rt_object_get_type(&mutex->parent.parent) == RT_Object_Class_Mutex)) { rt_assert_handler("rt_object_get_type(&mutex->parent.parent) == RT_Object_Class_Mutex", __FUNCTION__, 582); };
    if (!(rt_object_is_systemobject(&mutex->parent.parent))) { rt_assert_handler("rt_object_is_systemobject(&mutex->parent.parent)", __FUNCTION__, 583); };
...
;
# 606 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_mutex_t rt_mutex_create(const char *name, rt_uint8_t flag)
{
    struct rt_mutex *mutex;

    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 610); } } rt_hw_interrupt_enable(level); } while (0);
...
;
# 641 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_mutex_delete(rt_mutex_t mutex)
{
    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 643); } } rt_hw_interrupt_enable(level); } while (0);


    if (!(mutex != (0))) { rt_assert_handler("mutex != RT_NULL", __FUNCTION__, 646); };
    if (!(rt_object_get_type(&mutex->parent.parent) == RT_Object_Class_Mutex)) { rt_assert_handler("rt_object_get_type(&mutex->parent.parent) == RT_Object_Class_Mutex", __FUNCTION__, 647); };
    if (!(rt_object_is_systemobject(&mutex->parent.parent) == 0)) { rt_assert_handler("rt_object_is_systemobject(&mutex->parent.parent) == RT_FALSE", __FUNCTION__, 648); };
...
;
# 670 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_mutex_take(rt_mutex_t mutex, rt_int32_t time)
{
    register rt_base_t temp;
    struct rt_thread *thread;
    ...
    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_thread_self() == (0)) { rt_kprintf("Function[%s] shall not be used before scheduler start\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 676); } } do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 676); } } rt_hw_interrupt_enable(level); } while (0); rt_hw_interrupt_enable(level); } while (0);


    if (!(mutex != (0))) { rt_assert_handler("mutex != RT_NULL", __FUNCTION__, 679); };
    if (!(rt_object_get_type(&mutex->parent.parent) == RT_Object_Class_Mutex)) { rt_assert_handler("rt_object_get_type(&mutex->parent.parent) == RT_Object_Class_Mutex", __FUNCTION__, 680); };
...
;
# 826 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_mutex_release(rt_mutex_t mutex)
{
    register rt_base_t temp;
    struct rt_thread *thread;
    ...
    if (!(mutex != (0))) { rt_assert_handler("mutex != RT_NULL", __FUNCTION__, 833); };
    if (!(rt_object_get_type(&mutex->parent.parent) == RT_Object_Class_Mutex)) { rt_assert_handler("rt_object_get_type(&mutex->parent.parent) == RT_Object_Class_Mutex", __FUNCTION__, 834); };

    need_schedule = 0;


    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_thread_self() == (0)) { rt_kprintf("Function[%s] shall not be used before scheduler start\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 839); } } do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 839); } } rt_hw_interrupt_enable(level); } while (0); rt_hw_interrupt_enable(level); } while (0);
...
;
# 945 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_mutex_control(rt_mutex_t mutex, int cmd, void *arg)
{

    if (!(mutex != (0))) { rt_assert_handler("mutex != RT_NULL", __FUNCTION__, 948); };
    if (!(rt_object_get_type(&mutex->parent.parent) == RT_Object_Class_Mutex)) { rt_assert_handler("rt_object_get_type(&mutex->parent.parent) == RT_Object_Class_Mutex", __FUNCTION__, 949); };

    return -1;
}
;
# 967 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_event_init(rt_event_t event, const char *name, rt_uint8_t flag)
{

    if (!(event != (0))) { rt_assert_handler("event != RT_NULL", __FUNCTION__, 970); };
...
;
# 995 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_event_detach(rt_event_t event)
{

    if (!(event != (0))) { rt_assert_handler("event != RT_NULL", __FUNCTION__, 998); };
    if (!(rt_object_get_type(&event->parent.parent) == RT_Object_Class_Event)) { rt_assert_handler("rt_object_get_type(&event->parent.parent) == RT_Object_Class_Event", __FUNCTION__, 999); };
    if (!(rt_object_is_systemobject(&event->parent.parent))) { rt_assert_handler("rt_object_is_systemobject(&event->parent.parent)", __FUNCTION__, 1000); };
...
;
# 1021 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_event_t rt_event_create(const char *name, rt_uint8_t flag)
{
    rt_event_t event;

    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1025); } } rt_hw_interrupt_enable(level); } while (0);
...
;
# 1052 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_event_delete(rt_event_t event)
{

    if (!(event != (0))) { rt_assert_handler("event != RT_NULL", __FUNCTION__, 1055); };
    if (!(rt_object_get_type(&event->parent.parent) == RT_Object_Class_Event)) { rt_assert_handler("rt_object_get_type(&event->parent.parent) == RT_Object_Class_Event", __FUNCTION__, 1056); };
    if (!(rt_object_is_systemobject(&event->parent.parent) == 0)) { rt_assert_handler("rt_object_is_systemobject(&event->parent.parent) == RT_FALSE", __FUNCTION__, 1057); };

    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1059); } } rt_hw_interrupt_enable(level); } while (0);
...
;
# 1081 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_event_send(rt_event_t event, rt_uint32_t set)
{
    struct rt_list_node *n;
    struct rt_thread *thread;
    ...
    if (!(event != (0))) { rt_assert_handler("event != RT_NULL", __FUNCTION__, 1090); };
    if (!(rt_object_get_type(&event->parent.parent) == RT_Object_Class_Event)) { rt_assert_handler("rt_object_get_type(&event->parent.parent) == RT_Object_Class_Event", __FUNCTION__, 1091); };
...
;
# 1186 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_event_recv(rt_event_t event,
                       rt_uint32_t set,
                       rt_uint8_t option,
                       rt_int32_t timeout,
                       rt_uint32_t *recved)
{
    ...
    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_thread_self() == (0)) { rt_kprintf("Function[%s] shall not be used before scheduler start\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1196); } } do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1196); } } rt_hw_interrupt_enable(level); } while (0); rt_hw_interrupt_enable(level); } while (0);


    if (!(event != (0))) { rt_assert_handler("event != RT_NULL", __FUNCTION__, 1199); };
    if (!(rt_object_get_type(&event->parent.parent) == RT_Object_Class_Event)) { rt_assert_handler("rt_object_get_type(&event->parent.parent) == RT_Object_Class_Event", __FUNCTION__, 1200); };
    ...
    else
    {
        ...
        if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1231); };
    }
...
;
# 1317 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_event_control(rt_event_t event, int cmd, void *arg)
{
    rt_ubase_t level;


    if (!(event != (0))) { rt_assert_handler("event != RT_NULL", __FUNCTION__, 1322); };
    if (!(rt_object_get_type(&event->parent.parent) == RT_Object_Class_Event)) { rt_assert_handler("rt_object_get_type(&event->parent.parent) == RT_Object_Class_Event", __FUNCTION__, 1323); };
...
;
# 1362 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_mb_init(rt_mailbox_t mb,
                    const char *name,
                    void *msgpool,
                    rt_size_t size,
                    rt_uint8_t flag)
{
    if (!(mb != (0))) { rt_assert_handler("mb != RT_NULL", __FUNCTION__, 1368); };
...
;
# 1400 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_mb_detach(rt_mailbox_t mb)
{

    if (!(mb != (0))) { rt_assert_handler("mb != RT_NULL", __FUNCTION__, 1403); };
    if (!(rt_object_get_type(&mb->parent.parent) == RT_Object_Class_MailBox)) { rt_assert_handler("rt_object_get_type(&mb->parent.parent) == RT_Object_Class_MailBox", __FUNCTION__, 1404); };
    if (!(rt_object_is_systemobject(&mb->parent.parent))) { rt_assert_handler("rt_object_is_systemobject(&mb->parent.parent)", __FUNCTION__, 1405); };
...
;
# 1429 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_mailbox_t rt_mb_create(const char *name, rt_size_t size, rt_uint8_t flag)
{
    rt_mailbox_t mb;

    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1433); } } rt_hw_interrupt_enable(level); } while (0);
...
;
# 1474 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_mb_delete(rt_mailbox_t mb)
{
    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1476); } } rt_hw_interrupt_enable(level); } while (0);


    if (!(mb != (0))) { rt_assert_handler("mb != RT_NULL", __FUNCTION__, 1479); };
    if (!(rt_object_get_type(&mb->parent.parent) == RT_Object_Class_MailBox)) { rt_assert_handler("rt_object_get_type(&mb->parent.parent) == RT_Object_Class_MailBox", __FUNCTION__, 1480); };
    if (!(rt_object_is_systemobject(&mb->parent.parent) == 0)) { rt_assert_handler("rt_object_is_systemobject(&mb->parent.parent) == RT_FALSE", __FUNCTION__, 1481); };
...
;
# 1510 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_mb_send_wait(rt_mailbox_t mb,
                         rt_ubase_t value,
                         rt_int32_t timeout)
{
    ...
    if (!(mb != (0))) { rt_assert_handler("mb != RT_NULL", __FUNCTION__, 1519); };
    if (!(rt_object_get_type(&mb->parent.parent) == RT_Object_Class_MailBox)) { rt_assert_handler("rt_object_get_type(&mb->parent.parent) == RT_Object_Class_MailBox", __FUNCTION__, 1520); };
    ...
    while (mb->entry == mb->size)
    {
        ...
        do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_thread_self() == (0)) { rt_kprintf("Function[%s] shall not be used before scheduler start\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1555); } } do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1555); } } rt_hw_interrupt_enable(level); } while (0); rt_hw_interrupt_enable(level); } while (0);
...
;
# 1651 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_mb_send(rt_mailbox_t mb, rt_ubase_t value)
{
    return rt_mb_send_wait(mb, value, 0);
}
;
# 1667 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_mb_recv(rt_mailbox_t mb, rt_ubase_t *value, rt_int32_t timeout)
{
    struct rt_thread *thread;
    register rt_ubase_t temp;
    ...
    if (!(mb != (0))) { rt_assert_handler("mb != RT_NULL", __FUNCTION__, 1674); };
    if (!(rt_object_get_type(&mb->parent.parent) == RT_Object_Class_MailBox)) { rt_assert_handler("rt_object_get_type(&mb->parent.parent) == RT_Object_Class_MailBox", __FUNCTION__, 1675); };
    ...
    while (mb->entry == 0)
    {
        ...
        do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_thread_self() == (0)) { rt_kprintf("Function[%s] shall not be used before scheduler start\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1712); } } do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1712); } } rt_hw_interrupt_enable(level); } while (0); rt_hw_interrupt_enable(level); } while (0);
...
;
# 1803 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_mb_control(rt_mailbox_t mb, int cmd, void *arg)
{
    rt_ubase_t level;


    if (!(mb != (0))) { rt_assert_handler("mb != RT_NULL", __FUNCTION__, 1808); };
    if (!(rt_object_get_type(&mb->parent.parent) == RT_Object_Class_MailBox)) { rt_assert_handler("rt_object_get_type(&mb->parent.parent) == RT_Object_Class_MailBox", __FUNCTION__, 1809); };
...
# 1858 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_mq_init(rt_mq_t mq,
                    const char *name,
                    void *msgpool,
                    rt_size_t msg_size,
                    ...
                    rt_uint8_t flag)
{
    ...
    if (!(mq != (0))) { rt_assert_handler("mq != RT_NULL", __FUNCTION__, 1869); };
...
;
# 1918 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_mq_detach(rt_mq_t mq)
{

    if (!(mq != (0))) { rt_assert_handler("mq != RT_NULL", __FUNCTION__, 1921); };
    if (!(rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue)) { rt_assert_handler("rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue", __FUNCTION__, 1922); };
    if (!(rt_object_is_systemobject(&mq->parent.parent))) { rt_assert_handler("rt_object_is_systemobject(&mq->parent.parent)", __FUNCTION__, 1923); };
...
;
# 1948 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_mq_t rt_mq_create(const char *name,
                     rt_size_t msg_size,
                     rt_size_t max_msgs,
                     rt_uint8_t flag)
{
    ...
    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1957); } } rt_hw_interrupt_enable(level); } while (0);
...
;
# 2016 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_mq_delete(rt_mq_t mq)
{
    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 2018); } } rt_hw_interrupt_enable(level); } while (0);


    if (!(mq != (0))) { rt_assert_handler("mq != RT_NULL", __FUNCTION__, 2021); };
    if (!(rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue)) { rt_assert_handler("rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue", __FUNCTION__, 2022); };
    if (!(rt_object_is_systemobject(&mq->parent.parent) == 0)) { rt_assert_handler("rt_object_is_systemobject(&mq->parent.parent) == RT_FALSE", __FUNCTION__, 2023); };
...
;
# 2052 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_mq_send_wait(rt_mq_t mq,
                         const void *buffer,
                         rt_size_t size,
                         rt_int32_t timeout)
{
    ...
    if (!(mq != (0))) { rt_assert_handler("mq != RT_NULL", __FUNCTION__, 2063); };
    if (!(rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue)) { rt_assert_handler("rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue", __FUNCTION__, 2064); };
    if (!(buffer != (0))) { rt_assert_handler("buffer != RT_NULL", __FUNCTION__, 2065); };
    if (!(size != 0)) { rt_assert_handler("size != 0", __FUNCTION__, 2066); };
    ...
    while ((msg = mq->msg_queue_free) == (0))
    {
        ...
        do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_thread_self() == (0)) { rt_kprintf("Function[%s] shall not be used before scheduler start\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 2108); } } do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 2108); } } rt_hw_interrupt_enable(level); } while (0); rt_hw_interrupt_enable(level); } while (0);
        ...
        if (timeout > 0)
        {
            ...
            do { if (0) rt_kprintf ("mq_send_wait: start timer of thread:%s\n", thread->name); } while (0)
                                                      ;
...
# 2223 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_mq_send(rt_mq_t mq, const void *buffer, rt_size_t size)
{
    return rt_mq_send_wait(mq, buffer, size, 0);
}
;
# 2240 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_mq_urgent(rt_mq_t mq, const void *buffer, rt_size_t size)
{
    register rt_ubase_t temp;
    struct rt_mq_message *msg;
    ...
    if (!(mq != (0))) { rt_assert_handler("mq != RT_NULL", __FUNCTION__, 2246); };
    if (!(rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue)) { rt_assert_handler("rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue", __FUNCTION__, 2247); };
    if (!(buffer != (0))) { rt_assert_handler("buffer != RT_NULL", __FUNCTION__, 2248); };
    if (!(size != 0)) { rt_assert_handler("size != 0", __FUNCTION__, 2249); };
...
;
# 2333 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_mq_recv(rt_mq_t mq,
                    void *buffer,
                    rt_size_t size,
                    rt_int32_t timeout)
{
    ...
    if (!(mq != (0))) { rt_assert_handler("mq != RT_NULL", __FUNCTION__, 2344); };
    if (!(rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue)) { rt_assert_handler("rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue", __FUNCTION__, 2345); };
    if (!(buffer != (0))) { rt_assert_handler("buffer != RT_NULL", __FUNCTION__, 2346); };
    if (!(size != 0)) { rt_assert_handler("size != 0", __FUNCTION__, 2347); };
    ...
    while (mq->entry == 0)
    {
        do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_thread_self() == (0)) { rt_kprintf("Function[%s] shall not be used before scheduler start\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 2369); } } do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 2369); } } rt_hw_interrupt_enable(level); } while (0); rt_hw_interrupt_enable(level); } while (0);
...
;
# 2490 "/home/rudy/workspace/Projects/rt-thread/src/ipc.c"
rt_err_t rt_mq_control(rt_mq_t mq, int cmd, void *arg)
{
    rt_ubase_t level;
    struct rt_mq_message *msg;
    ...
    if (!(mq != (0))) { rt_assert_handler("mq != RT_NULL", __FUNCTION__, 2496); };
    if (!(rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue)) { rt_assert_handler("rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue", __FUNCTION__, 2497); };
