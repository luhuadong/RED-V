# 1 "/home/rudy/workspace/Projects/rt-thread/src/scheduler.c"
...
# 1 "/home/rudy/workspace/Projects/rt-thread/src/scheduler.c"
# 33 "/home/rudy/workspace/Projects/rt-thread/src/scheduler.c"
...
# 34 "/home/rudy/workspace/Projects/rt-thread/src/scheduler.c" 2
...
# 35 "/home/rudy/workspace/Projects/rt-thread/src/scheduler.c" 2

rt_list_t rt_thread_priority_table[256];
...
# 67 "/home/rudy/workspace/Projects/rt-thread/src/scheduler.c"
void
...
{
    if (!(thread != (0))) { rt_assert_handler("thread != RT_NULL", __FUNCTION__, 79); };
...
# 158 "/home/rudy/workspace/Projects/rt-thread/src/scheduler.c"
...
# 226 "/home/rudy/workspace/Projects/rt-thread/src/scheduler.c"
...
# 414 "/home/rudy/workspace/Projects/rt-thread/src/scheduler.c"
void rt_schedule(void)
{
    rt_base_t level;
    ...
    if (rt_scheduler_lock_nest == 0)
    {
        ...
        if (rt_thread_ready_priority_group != 0)
        {
            ...
            if (to_thread != rt_current_thread)
            {
                ...
                do { if (0) rt_kprintf ("[%d]switch to priority#%d " "thread:%.*s(sp:0x%08x), " "from thread:%.*s(sp: 0x%08x)\n", rt_interrupt_nest, highest_ready_priority, 32, to_thread->name, to_thread->sp, 32, from_thread->name, from_thread->sp); } while (0)
...
# 511 "/home/rudy/workspace/Projects/rt-thread/src/scheduler.c"
                    goto __exit;
                }
                else
                {
...
# 704 "/home/rudy/workspace/Projects/rt-thread/src/scheduler.c"
void rt_schedule_insert_thread(struct rt_thread *thread)
{
    register rt_base_t temp;

    if (!(thread != (0))) { rt_assert_handler("thread != RT_NULL", __FUNCTION__, 708); };
    ...
    thread->stat = 0x01 | (thread->stat & ~0x07);

    rt_list_insert_before(&(rt_thread_priority_table[thread->current_priority]),
                          &(thread->tlist));

    do { if (0) rt_kprintf ("insert thread[%.*s], the priority: %d\n", 32, thread->name, thread->current_priority); } while (0)
                                                                                           ;
...
# 801 "/home/rudy/workspace/Projects/rt-thread/src/scheduler.c"
void rt_schedule_remove_thread(struct rt_thread *thread)
{
    register rt_base_t level;

    if (!(thread != (0))) { rt_assert_handler("thread != RT_NULL", __FUNCTION__, 805); };
...
# 877 "/home/rudy/workspace/Projects/rt-thread/src/scheduler.c"
void rt_enter_critical(void)
{
    register rt_base_t level;
...
;
# 941 "/home/rudy/workspace/Projects/rt-thread/src/scheduler.c"
void rt_exit_critical(void)
{
    register rt_base_t level;
