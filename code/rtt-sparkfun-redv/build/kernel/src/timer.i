# 1 "/home/rudy/workspace/Projects/rt-thread/src/timer.c"
...
# 1 "/home/rudy/workspace/Projects/rt-thread/src/timer.c"
# 21 "/home/rudy/workspace/Projects/rt-thread/src/timer.c"
...
# 22 "/home/rudy/workspace/Projects/rt-thread/src/timer.c" 2
...
# 23 "/home/rudy/workspace/Projects/rt-thread/src/timer.c" 2


static rt_list_t rt_timer_list[1];
# 50 "/home/rudy/workspace/Projects/rt-thread/src/timer.c"
...
# 67 "/home/rudy/workspace/Projects/rt-thread/src/timer.c"
void rt_timer_enter_sethook(void (*hook)(struct rt_timer *timer))
{
...
static rt_tick_t rt_timer_list_next_timeout(rt_list_t timer_list[])
{
    ...
    rt_tick_t timeout_tick = 0xffffffff;
...
# 193 "/home/rudy/workspace/Projects/rt-thread/src/timer.c"
void rt_timer_init(rt_timer_t timer,
                   const char *name,
                   void (*timeout)(void *parameter),
                   void *parameter,
                   ...
                   rt_uint8_t flag)
{
    ...
    if (!(timer != (0))) { rt_assert_handler("timer != RT_NULL", __FUNCTION__, 201); };
...
;
# 217 "/home/rudy/workspace/Projects/rt-thread/src/timer.c"
rt_err_t rt_timer_detach(rt_timer_t timer)
{
    register rt_base_t level;


    if (!(timer != (0))) { rt_assert_handler("timer != RT_NULL", __FUNCTION__, 222); };
    if (!(rt_object_get_type(&timer->parent) == RT_Object_Class_Timer)) { rt_assert_handler("rt_object_get_type(&timer->parent) == RT_Object_Class_Timer", __FUNCTION__, 223); };
    if (!(rt_object_is_systemobject(&timer->parent))) { rt_assert_handler("rt_object_is_systemobject(&timer->parent)", __FUNCTION__, 224); };
...
;
# 254 "/home/rudy/workspace/Projects/rt-thread/src/timer.c"
rt_timer_t rt_timer_create(const char *name,
                           void (*timeout)(void *parameter),
                           void *parameter,
                           rt_tick_t time,
...
;
# 282 "/home/rudy/workspace/Projects/rt-thread/src/timer.c"
rt_err_t rt_timer_delete(rt_timer_t timer)
{
    register rt_base_t level;


    if (!(timer != (0))) { rt_assert_handler("timer != RT_NULL", __FUNCTION__, 287); };
    if (!(rt_object_get_type(&timer->parent) == RT_Object_Class_Timer)) { rt_assert_handler("rt_object_get_type(&timer->parent) == RT_Object_Class_Timer", __FUNCTION__, 288); };
    if (!(rt_object_is_systemobject(&timer->parent) == 0)) { rt_assert_handler("rt_object_is_systemobject(&timer->parent) == RT_FALSE", __FUNCTION__, 289); };
...
;
# 315 "/home/rudy/workspace/Projects/rt-thread/src/timer.c"
rt_err_t rt_timer_start(rt_timer_t timer)
{
    ...
    if (!(timer != (0))) { rt_assert_handler("timer != RT_NULL", __FUNCTION__, 325); };
    if (!(rt_object_get_type(&timer->parent) == RT_Object_Class_Timer)) { rt_assert_handler("rt_object_get_type(&timer->parent) == RT_Object_Class_Timer", __FUNCTION__, 326); };
    ...
    if (!(timer->init_tick < 0xffffffff / 2)) { rt_assert_handler("timer->init_tick < RT_TICK_MAX / 2", __FUNCTION__, 342); };
    timer->timeout_tick = rt_tick_get() + timer->init_tick;


    level = rt_hw_interrupt_disable();
# 356 "/home/rudy/workspace/Projects/rt-thread/src/timer.c"
    {
    ...
    rt_hw_interrupt_enable(level);
# 431 "/home/rudy/workspace/Projects/rt-thread/src/timer.c"
    return 0;
}
;
# 442 "/home/rudy/workspace/Projects/rt-thread/src/timer.c"
rt_err_t rt_timer_stop(rt_timer_t timer)
{
    register rt_base_t level;


    if (!(timer != (0))) { rt_assert_handler("timer != RT_NULL", __FUNCTION__, 447); };
    if (!(rt_object_get_type(&timer->parent) == RT_Object_Class_Timer)) { rt_assert_handler("rt_object_get_type(&timer->parent) == RT_Object_Class_Timer", __FUNCTION__, 448); };
...
;
# 478 "/home/rudy/workspace/Projects/rt-thread/src/timer.c"
rt_err_t rt_timer_control(rt_timer_t timer, int cmd, void *arg)
{
    register rt_base_t level;


    if (!(timer != (0))) { rt_assert_handler("timer != RT_NULL", __FUNCTION__, 483); };
    if (!(rt_object_get_type(&timer->parent) == RT_Object_Class_Timer)) { rt_assert_handler("rt_object_get_type(&timer->parent) == RT_Object_Class_Timer", __FUNCTION__, 484); };
...
# 728 "/home/rudy/workspace/Projects/rt-thread/src/timer.c"
void rt_system_timer_init(void)
{
    int i;
...
void rt_system_timer_thread_init(void)
{
# 768 "/home/rudy/workspace/Projects/rt-thread/src/timer.c"
}
