...
.LFE3:
	...
	.local	idle
	.comm	idle,180,4
	.local	rt_thread_stack
	.comm	rt_thread_stack,1024,4
...
.LFB15:
	.file 2 "/home/rudy/workspace/Projects/rt-thread/src/idle.c"
	.loc 2 73 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L6:
	...
	j	.L5
.L4:
	.loc 2 81 25 discriminator 2
	lw	a5,-20(s0)
	addi	a5,a5,1
	sw	a5,-20(s0)
.L3:
	.loc 2 81 5 discriminator 1
	lw	a4,-20(s0)
	li	a5,3
	bleu	a4,a5,.L6
.L5:
...
.LFE16:
	...
	.align	1
	.type	_has_defunct_thread, @function
_has_defunct_thread:
.LFB17:
	.loc 2 132 1
	.cfi_startproc
	...
	.cfi_endproc
.LFE17:
	.size	_has_defunct_thread, .-_has_defunct_thread
	.section	.rodata
	.align	2
.LC0:
...
.LBB3:
	...
	.loc 2 160 69
	beq	a5,zero,.L18
	.loc 2 160 102 discriminator 1
	lla	a1,__FUNCTION__.3102
	lla	a0,.LC0
	call	rt_kprintf
	.loc 2 160 183 discriminator 1
	li	a2,160
	lla	a1,__FUNCTION__.3102
	lla	a0,.LC1
	call	rt_assert_handler
.L18:
	.loc 2 160 230 discriminator 5
	lw	a0,-20(s0)
	call	rt_hw_interrupt_enable
.LBE3:
	.loc 2 163 16 discriminator 5
	call	rt_hw_interrupt_disable
	sw	a0,-24(s0)
	.loc 2 166 13 discriminator 5
	call	_has_defunct_thread
	mv	a5,a0
	.loc 2 166 12 discriminator 5
	beq	a5,zero,.L19
	.loc 2 169 70
	lla	a5,rt_thread_defunct
	lw	a5,0(a5)
...
.LFB20:
	...
	j	.L32
.L33:
	.loc 2 279 9 discriminator 3
	addi	a5,s0,-52
	lw	a2,-20(s0)
	lla	a1,.LC2
	mv	a0,a5
	call	rt_sprintf
	.loc 2 280 9 discriminator 3
	lw	a4,-20(s0)
	li	a5,180
	mul	a4,a4,a5
	lla	a5,idle
	add	a0,a4,a5
	.loc 2 284 17 discriminator 3
	lw	a5,-20(s0)
	slli	a4,a5,10
	lla	a5,rt_thread_stack
	add	a4,a4,a5
	.loc 2 280 9 discriminator 3
	addi	a1,s0,-52
	li	a7,32
...
.LFE21:
	...
	.section	.rodata
	.align	2
	.type	__FUNCTION__.3102, @object
	.size	__FUNCTION__.3102, 22
__FUNCTION__.3102:
...
.LASF1882:
	.string	"/home/rudy/workspace/Projects/rt-thread/src/idle.c"
.LASF572:
