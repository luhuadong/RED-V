...
.LFB15:
	.file 2 "/home/rudy/workspace/Projects/rt-thread/src/thread.c"
	.loc 2 50 1
	.cfi_startproc
	addi	sp,sp,-32
	.cfi_def_cfa_offset 32
...
.LFB18:
	...
	li	a5,1
	bne	a4,a5,.L8
	.loc 2 100 15 discriminator 1
	lw	a5,-20(s0)
	lw	a5,172(a5)
	.loc 2 99 63 discriminator 1
	bne	a5,zero,.L8
	.loc 2 102 9
	lw	a0,-20(s0)
...
.L11:
	...
	.cfi_endproc
.LFE19:
	.size	_rt_thread_init, .-_rt_thread_init
	.section	.rodata
	.align	2
.LC0:
	.string	"thread != RT_NULL"
	.align	2
.LC1:
	.string	"stack_start != RT_NULL"
	.text
	.align	1
...
.LFB20:
	...
	lw	a5,-20(s0)
	bne	a5,zero,.L14
	.loc 2 242 29 discriminator 1
	li	a2,242
	lla	a1,__FUNCTION__.3114
	lla	a0,.LC0
...
.LFE21:
	...
	.align	2
.LC2:
	.string	"(thread->stat & RT_THREAD_STAT_MASK) == RT_THREAD_INIT"
	.align	2
.LC3:
	.string	"rt_object_get_type((rt_object_t)thread) == RT_Object_Class_Thread"
	.text
	.align	1
...
.LFE22:
	...
	.align	2
.LC4:
	.string	"rt_object_is_systemobject((rt_object_t)thread)"
	.text
	.align	1
...
.L31:
	...
	li	a5,1
	bne	a4,a5,.L32
	.loc 2 357 15 discriminator 1
	lw	a5,-36(s0)
	lw	a5,172(a5)
	.loc 2 356 63 discriminator 1
	bne	a5,zero,.L32
	.loc 2 359 9
	lw	a0,-36(s0)
	call	rt_object_detach
...
.LFE24:
	...
	.align	2
.LC5:
	.string	"rt_object_is_systemobject((rt_object_t)thread) == RT_FALSE"
	.text
	.align	1
...
.LFB25:
	...
	lw	a5,-36(s0)
	bne	a5,zero,.L39
	.loc 2 439 29 discriminator 1
	li	a2,439
	lla	a1,__FUNCTION__.3144
	lla	a0,.LC0
	call	rt_assert_handler
.L39:
	.loc 2 440 11
...
.LFB27:
	...
	lw	a5,-20(s0)
	bne	a5,zero,.L48
	.loc 2 509 29 discriminator 1
	li	a2,509
	lla	a1,__FUNCTION__.3155
	lla	a0,.LC0
	call	rt_assert_handler
.L48:
	.loc 2 510 11
...
.LFB29:
	...
	lw	a5,-36(s0)
	bne	a5,zero,.L55
	.loc 2 560 27 discriminator 1
	li	a2,560
	lla	a1,__FUNCTION__.3165
	lla	a0,.LC6
	call	rt_assert_handler
.L55:
	.loc 2 563 14
...
.LFB31:
	...
	lw	a5,-20(s0)
	bne	a5,zero,.L65
	.loc 2 639 29 discriminator 1
	li	a2,639
	lla	a1,__FUNCTION__.3176
	lla	a0,.LC0
	call	rt_assert_handler
.L65:
	.loc 2 640 11
...
.LFB32:
	...
	lw	a5,-20(s0)
	bne	a5,zero,.L77
	.loc 2 743 29 discriminator 1
	li	a2,743
	lla	a1,__FUNCTION__.3187
	lla	a0,.LC0
	call	rt_assert_handler
.L77:
	.loc 2 744 11
...
.LFB33:
	...
	lw	a5,-20(s0)
	bne	a5,zero,.L85
	.loc 2 791 29 discriminator 1
	li	a2,791
	lla	a1,__FUNCTION__.3192
	lla	a0,.LC0
	call	rt_assert_handler
.L85:
	.loc 2 792 11
...
.LFE33:
	...
	.align	2
.LC8:
	.string	"(thread->stat & RT_THREAD_STAT_MASK) == RT_THREAD_SUSPEND"
	.text
	.align	1
...
.L96:
	...
	lw	a5,-24(s0)
	bne	a5,zero,.L97
	.loc 2 875 34 discriminator 1
	li	a2,875
	lla	a1,__FUNCTION__.3204
	lla	a0,.LC9
	call	rt_assert_handler
.L97:
	.loc 2 876 15
...
.L99:
	...
	sw	a5,-20(s0)
.L98:
	.loc 2 877 18 discriminator 1
	lw	a5,-24(s0)
	addi	a5,a5,4
	.loc 2 876 5 discriminator 1
	lw	a4,-20(s0)
	bne	a4,a5,.L102
	.loc 2 892 9
	call	rt_thread_self
...
.LFE35:
	...
	.section	.rodata
	.align	2
	.type	__FUNCTION__.3114, @object
	.size	__FUNCTION__.3114, 15
__FUNCTION__.3114:
	.string	"rt_thread_init"
	.align	2
	.type	__FUNCTION__.3123, @object
	.size	__FUNCTION__.3123, 18
__FUNCTION__.3123:
	.string	"rt_thread_startup"
	.align	2
	.type	__FUNCTION__.3128, @object
	.size	__FUNCTION__.3128, 17
__FUNCTION__.3128:
	.string	"rt_thread_detach"
	.align	2
	.type	__FUNCTION__.3144, @object
	.size	__FUNCTION__.3144, 17
__FUNCTION__.3144:
	.string	"rt_thread_delete"
	.align	2
	.type	__FUNCTION__.3155, @object
	.size	__FUNCTION__.3155, 16
__FUNCTION__.3155:
	.string	"rt_thread_sleep"
	.align	2
	.type	__FUNCTION__.3165, @object
	.size	__FUNCTION__.3165, 22
__FUNCTION__.3165:
	.string	"rt_thread_delay_until"
	.align	2
	.type	__FUNCTION__.3176, @object
	.size	__FUNCTION__.3176, 18
__FUNCTION__.3176:
	.string	"rt_thread_control"
	.align	2
	.type	__FUNCTION__.3187, @object
	.size	__FUNCTION__.3187, 18
__FUNCTION__.3187:
	.string	"rt_thread_suspend"
	.align	2
	.type	__FUNCTION__.3192, @object
	.size	__FUNCTION__.3192, 17
__FUNCTION__.3192:
	.string	"rt_thread_resume"
	.align	2
	.type	__FUNCTION__.3197, @object
	.size	__FUNCTION__.3197, 18
__FUNCTION__.3197:
	.string	"rt_thread_timeout"
	.align	2
	.type	__FUNCTION__.3204, @object
	.size	__FUNCTION__.3204, 15
__FUNCTION__.3204:
...
.Ldebug_macro0:
	...
	.byte	0x4
	.4byte	.LASF316
	.file 12 "/home/rudy/workspace/Projects/rt-thread/include/rthw.h"
	.byte	0x3
	.byte	0x1f
	.byte	0xc
	.byte	0x5
	...
	.4byte	.Ldebug_macro2
	.byte	0x4
	.file 14 "/home/rudy/workspace/Projects/rt-thread/include/rtdebug.h"
	.byte	0x3
	.byte	0x17
	.byte	0xe
	.byte	0x7
	...
	.byte	0x7
	.4byte	.Ldebug_macro4
	.file 15 "/home/rudy/workspace/Projects/rt-thread/include/rtlibc.h"
	.byte	0x3
	.byte	0xce,0x8
	.byte	0xf
	.byte	0x5
	.byte	0xc
	.4byte	.LASF528
	.file 16 "/home/rudy/workspace/Projects/rt-thread/include/libc/libc_stat.h"
	.byte	0x3
	.byte	0xf
	.byte	0x10
	.byte	0x5
	.byte	0x8
	.4byte	.LASF529
	.file 17 "/home/rudy/opt/FreedomStudio/SiFive/riscv64-unknown-elf-gcc-8.3.0-2020.04.1/riscv64-unknown-elf/include/sys/stat.h"
	.byte	0x3
	.byte	0xe
	.byte	0x11
	.byte	0x5
	.byte	0x2
	.4byte	.LASF530
	.file 18 "/home/rudy/opt/FreedomStudio/SiFive/riscv64-unknown-elf-gcc-8.3.0-2020.04.1/riscv64-unknown-elf/include/_ansi.h"
	.byte	0x3
	.byte	0x8
	.byte	0x12
	.byte	0x5
	.byte	0x8
	.4byte	.LASF531
	.file 19 "/home/rudy/opt/FreedomStudio/SiFive/riscv64-unknown-elf-gcc-8.3.0-2020.04.1/riscv64-unknown-elf/include/newlib.h"
	.byte	0x3
	.byte	0xa
	.byte	0x13
	.byte	0x5
	.byte	0x8
	.4byte	.LASF532
	.file 20 "/home/rudy/opt/FreedomStudio/SiFive/riscv64-unknown-elf-gcc-8.3.0-2020.04.1/riscv64-unknown-elf/include/_newlib_version.h"
	.byte	0x3
	.byte	0xe
	.byte	0x14
	.byte	0x7
	...
	.4byte	.Ldebug_macro7
	.byte	0x4
	.file 23 "/home/rudy/opt/FreedomStudio/SiFive/riscv64-unknown-elf-gcc-8.3.0-2020.04.1/riscv64-unknown-elf/include/sys/features.h"
	.byte	0x3
	.byte	0x5
	.byte	0x17
	.byte	0x7
	...
	.byte	0x2b
	.4byte	.LASF591
	.file 25 "/home/rudy/opt/FreedomStudio/SiFive/riscv64-unknown-elf-gcc-8.3.0-2020.04.1/riscv64-unknown-elf/include/machine/_default_types.h"
	.byte	0x3
	.byte	0x2d
	.byte	0x19
	.byte	0x7
	...
	.file 29 "/home/rudy/opt/FreedomStudio/SiFive/riscv64-unknown-elf-gcc-8.3.0-2020.04.1/riscv64-unknown-elf/include/sys/_stdint.h"
	.byte	0x3
	.byte	0x2e
	.byte	0x1d
	.byte	0x7
...
.LASF1922:
	.string	"/home/rudy/workspace/Projects/rt-thread/src/thread.c"
.LASF1297:
