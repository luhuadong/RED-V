...
.LFB15:
	.file 2 "/home/rudy/workspace/Projects/rt-thread/src/timer.c"
	.loc 2 68 1
	.cfi_startproc
	addi	sp,sp,-32
	.cfi_def_cfa_offset 32
...
.L9:
	...
	.cfi_endproc
.LFE17:
	.size	_rt_timer_init, .-_rt_timer_init
	.align	1
	.type	rt_timer_list_next_timeout, @function
...
.L12:
	...
	.cfi_endproc
.LFE18:
	.size	rt_timer_list_next_timeout, .-rt_timer_list_next_timeout
	.align	1
...
.LFB20:
	...
	lw	a5,-20(s0)
	bne	a5,zero,.L18
	.loc 2 201 28 discriminator 1
	li	a2,201
	lla	a1,__FUNCTION__.3118
	lla	a0,.LC0
...
.LFE20:
	...
	.align	2
.LC1:
	.string	"rt_object_get_type(&timer->parent) == RT_Object_Class_Timer"
	.align	2
.LC2:
	.string	"rt_object_is_systemobject(&timer->parent)"
	.text
	.align	1
...
.LFE22:
	...
	.align	2
.LC3:
	.string	"rt_object_is_systemobject(&timer->parent) == RT_FALSE"
	.text
	.align	1
...
.LFE23:
	...
	.align	2
.LC4:
	.string	"timer->init_tick < RT_TICK_MAX / 2"
	.text
	.align	1
...
.LFB24:
	...
	lw	a5,-52(s0)
	bne	a5,zero,.L33
	.loc 2 325 28 discriminator 1
	li	a2,325
	lla	a1,__FUNCTION__.3147
	lla	a0,.LC0
	call	rt_assert_handler
.L33:
	.loc 2 326 11
...
.LBE3:
	...
	sw	a4,-24(a5)
.L43:
	.loc 2 362 43 discriminator 2
	lw	a5,-20(s0)
	addi	a5,a5,1
	sw	a5,-20(s0)
.L37:
	.loc 2 362 5 discriminator 1
	lw	a5,-20(s0)
	beq	a5,zero,.L38
	.loc 2 395 14
	lla	a5,random_nr.3146
	lw	a5,0(a5)
	addi	a4,a5,1
	lla	a5,random_nr.3146
	sw	a4,0(a5)
...
.LFB25:
	...
	lw	a5,-20(s0)
	bne	a5,zero,.L55
	.loc 2 447 28 discriminator 1
	li	a2,447
	lla	a1,__FUNCTION__.3164
	lla	a0,.LC0
	call	rt_assert_handler
.L55:
	.loc 2 448 11
...
.LFB26:
	...
	lw	a5,-20(s0)
	bne	a5,zero,.L61
	.loc 2 483 28 discriminator 1
	li	a2,483
	lla	a1,__FUNCTION__.3171
	lla	a0,.LC0
	call	rt_assert_handler
.L61:
	.loc 2 484 11
...
.L81:
	...
	.loc 2 583 16
	beq	a5,zero,.L76
	.loc 2 584 27 discriminator 1
	lw	a5,-24(s0)
	lbu	a5,33(a5)
	.loc 2 584 33 discriminator 1
	andi	a5,a5,1
	.loc 2 583 40 discriminator 1
	beq	a5,zero,.L76
	.loc 2 587 32
	lw	a5,-24(s0)
	lbu	a5,33(a5)
...
.LFB28:
	...
	.loc 2 607 12
	lla	a0,rt_timer_list
	call	rt_timer_list_next_timeout
	mv	a5,a0
	.loc 2 608 1
	mv	a0,a5
	lw	ra,12(sp)
...
.LFB29:
	...
	j	.L90
.L91:
	.loc 2 734 36 discriminator 3
	lw	a5,-20(s0)
	slli	a4,a5,3
	.loc 2 734 9 discriminator 3
	lla	a5,rt_timer_list
	add	a5,a4,a5
	mv	a0,a5
	call	rt_list_init
	.loc 2 732 72 discriminator 3
	lw	a5,-20(s0)
	addi	a5,a5,1
	sw	a5,-20(s0)
.L90:
...
.LFE30:
	...
	.section	.rodata
	.align	2
	.type	__FUNCTION__.3118, @object
	.size	__FUNCTION__.3118, 14
__FUNCTION__.3118:
	.string	"rt_timer_init"
	.align	2
	.type	__FUNCTION__.3123, @object
	.size	__FUNCTION__.3123, 16
__FUNCTION__.3123:
	.string	"rt_timer_detach"
	.align	2
	.type	__FUNCTION__.3137, @object
	.size	__FUNCTION__.3137, 16
__FUNCTION__.3137:
	.string	"rt_timer_delete"
	.align	2
	.type	__FUNCTION__.3147, @object
	.size	__FUNCTION__.3147, 15
__FUNCTION__.3147:
	.string	"rt_timer_start"
	.local	random_nr.3146
	.comm	random_nr.3146,4,4
	.align	2
	.type	__FUNCTION__.3164, @object
	.size	__FUNCTION__.3164, 14
__FUNCTION__.3164:
	.string	"rt_timer_stop"
	.align	2
	.type	__FUNCTION__.3171, @object
	.size	__FUNCTION__.3171, 17
__FUNCTION__.3171:
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	random_nr.3146
	.byte	0x2f
	.4byte	.LASF1870
	.4byte	0xee4
	.byte	0x5
	.byte	0x3
	.4byte	__FUNCTION__.3147
	.byte	0x30
...
.LASF1190:
	.string	"F_GETOWN 5"
.LASF1893:
	.string	"/home/rudy/workspace/Projects/rt-thread/src/timer.c"
.LASF1490:
