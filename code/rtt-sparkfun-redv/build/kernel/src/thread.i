# 1 "/home/rudy/workspace/Projects/rt-thread/src/thread.c"
...
# 1 "/home/rudy/workspace/Projects/rt-thread/src/thread.c"
# 31 "/home/rudy/workspace/Projects/rt-thread/src/thread.c"
...
# 32 "/home/rudy/workspace/Projects/rt-thread/src/thread.c" 2
...
# 49 "/home/rudy/workspace/Projects/rt-thread/src/thread.c"
void rt_thread_suspend_sethook(void (*hook)(rt_thread_t thread))
{
    rt_thread_suspend_hook = hook;
}
# 62 "/home/rudy/workspace/Projects/rt-thread/src/thread.c"
void rt_thread_resume_sethook(void (*hook)(rt_thread_t thread))
{
                                ...
                                rt_uint32_t tick)
{
    ...
    if (!(priority < 256)) { rt_assert_handler("priority < RT_THREAD_PRIORITY_MAX", __FUNCTION__, 149); };
    ...
    thread->error = 0;
    thread->stat = 0x00;
# 179 "/home/rudy/workspace/Projects/rt-thread/src/thread.c"
    thread->cleanup = 0;
    thread->user_data = 0;
    ...
    rt_timer_init(&(thread->thread_timer),
                  ...
                  0,
                  0x0);
# 206 "/home/rudy/workspace/Projects/rt-thread/src/thread.c"
    do { if ((rt_thread_inited_hook) != (0)) rt_thread_inited_hook (thread); } while (0);

    return 0;
}
# 232 "/home/rudy/workspace/Projects/rt-thread/src/thread.c"
rt_err_t rt_thread_init(struct rt_thread *thread,
                        const char *name,
                        void (*entry)(void *parameter),
                        void *parameter,
                        ...
                        rt_uint32_t tick)
{
    ...
    if (!(thread != (0))) { rt_assert_handler("thread != RT_NULL", __FUNCTION__, 242); };
    if (!(stack_start != (0))) { rt_assert_handler("stack_start != RT_NULL", __FUNCTION__, 243); };
...
rt_thread_t rt_thread_self(void)
{
# 275 "/home/rudy/workspace/Projects/rt-thread/src/thread.c"
...
;
# 289 "/home/rudy/workspace/Projects/rt-thread/src/thread.c"
rt_err_t rt_thread_startup(rt_thread_t thread)
{

    if (!(thread != (0))) { rt_assert_handler("thread != RT_NULL", __FUNCTION__, 292); };
    if (!((thread->stat & 0x07) == 0x00)) { rt_assert_handler("(thread->stat & RT_THREAD_STAT_MASK) == RT_THREAD_INIT", __FUNCTION__, 293); };
    if (!(rt_object_get_type((rt_object_t)thread) == RT_Object_Class_Thread)) { rt_assert_handler("rt_object_get_type((rt_object_t)thread) == RT_Object_Class_Thread", __FUNCTION__, 294); };
...
;
# 332 "/home/rudy/workspace/Projects/rt-thread/src/thread.c"
rt_err_t rt_thread_detach(rt_thread_t thread)
{
    rt_base_t lock;


    if (!(thread != (0))) { rt_assert_handler("thread != RT_NULL", __FUNCTION__, 337); };
    if (!(rt_object_get_type((rt_object_t)thread) == RT_Object_Class_Thread)) { rt_assert_handler("rt_object_get_type((rt_object_t)thread) == RT_Object_Class_Thread", __FUNCTION__, 338); };
    if (!(rt_object_is_systemobject((rt_object_t)thread))) { rt_assert_handler("rt_object_is_systemobject((rt_object_t)thread)", __FUNCTION__, 339); };

    if ((thread->stat & 0x07) == 0x04)
        return 0;
...
;
# 389 "/home/rudy/workspace/Projects/rt-thread/src/thread.c"
rt_thread_t rt_thread_create(const char *name,
                             void (*entry)(void *parameter),
                             void *parameter,
                             rt_uint32_t stack_size,
...
;
# 434 "/home/rudy/workspace/Projects/rt-thread/src/thread.c"
rt_err_t rt_thread_delete(rt_thread_t thread)
{
    rt_base_t lock;


    if (!(thread != (0))) { rt_assert_handler("thread != RT_NULL", __FUNCTION__, 439); };
    if (!(rt_object_get_type((rt_object_t)thread) == RT_Object_Class_Thread)) { rt_assert_handler("rt_object_get_type((rt_object_t)thread) == RT_Object_Class_Thread", __FUNCTION__, 440); };
    if (!(rt_object_is_systemobject((rt_object_t)thread) == 0)) { rt_assert_handler("rt_object_is_systemobject((rt_object_t)thread) == RT_FALSE", __FUNCTION__, 441); };
...
;
# 479 "/home/rudy/workspace/Projects/rt-thread/src/thread.c"
rt_err_t rt_thread_yield(void)
{
    struct rt_thread *thread;
    rt_base_t lock;
...
;
# 502 "/home/rudy/workspace/Projects/rt-thread/src/thread.c"
rt_err_t rt_thread_sleep(rt_tick_t tick)
{
    ...
    thread = rt_thread_self();
    if (!(thread != (0))) { rt_assert_handler("thread != RT_NULL", __FUNCTION__, 509); };
    if (!(rt_object_get_type((rt_object_t)thread) == RT_Object_Class_Thread)) { rt_assert_handler("rt_object_get_type((rt_object_t)thread) == RT_Object_Class_Thread", __FUNCTION__, 510); };
...
# 541 "/home/rudy/workspace/Projects/rt-thread/src/thread.c"
rt_err_t rt_thread_delay(rt_tick_t tick)
{
    return rt_thread_sleep(tick);
}
;
# 555 "/home/rudy/workspace/Projects/rt-thread/src/thread.c"
rt_err_t rt_thread_delay_until(rt_tick_t *tick, rt_tick_t inc_tick)
{
    register rt_base_t level;
    struct rt_thread *thread;

    if (!(tick != (0))) { rt_assert_handler("tick != RT_NULL", __FUNCTION__, 560); };


    thread = rt_thread_self();
    if (!(thread != (0))) { rt_assert_handler("thread != RT_NULL", __FUNCTION__, 564); };
    if (!(rt_object_get_type((rt_object_t)thread) == RT_Object_Class_Thread)) { rt_assert_handler("rt_object_get_type((rt_object_t)thread) == RT_Object_Class_Thread", __FUNCTION__, 565); };
...
;
# 611 "/home/rudy/workspace/Projects/rt-thread/src/thread.c"
rt_err_t rt_thread_mdelay(rt_int32_t ms)
{
    rt_tick_t tick;
...
;
# 634 "/home/rudy/workspace/Projects/rt-thread/src/thread.c"
rt_err_t rt_thread_control(rt_thread_t thread, int cmd, void *arg)
{
    register rt_base_t temp;


    if (!(thread != (0))) { rt_assert_handler("thread != RT_NULL", __FUNCTION__, 639); };
    if (!(rt_object_get_type((rt_object_t)thread) == RT_Object_Class_Thread)) { rt_assert_handler("rt_object_get_type((rt_object_t)thread) == RT_Object_Class_Thread", __FUNCTION__, 640); };
    ...
    case 0x02:
        ...
        if ((thread->stat & 0x07) == 0x01)
        {
            ...
            thread->high_mask = 1 << (thread->current_priority & 0x07);
...
# 719 "/home/rudy/workspace/Projects/rt-thread/src/thread.c"
    default:
        break;
    }
...
;
# 737 "/home/rudy/workspace/Projects/rt-thread/src/thread.c"
rt_err_t rt_thread_suspend(rt_thread_t thread)
{
    ...
    if (!(thread != (0))) { rt_assert_handler("thread != RT_NULL", __FUNCTION__, 743); };
    if (!(rt_object_get_type((rt_object_t)thread) == RT_Object_Class_Thread)) { rt_assert_handler("rt_object_get_type((rt_object_t)thread) == RT_Object_Class_Thread", __FUNCTION__, 744); };

    do { if (0) rt_kprintf ("thread suspend:  %s\n", thread->name); } while (0);

    stat = thread->stat & 0x07;
    if ((stat != 0x01) && (stat != 0x03))
    {
        do { if (0) rt_kprintf ("thread suspend: thread disorder, 0x%2x\n", thread->stat); } while (0)
                                                     ;
        return -1;
    }
    ...
    if (stat == 0x03)
    {
        ...
        if (!(thread == rt_thread_self())) { rt_assert_handler("thread == rt_thread_self()", __FUNCTION__, 761); };
    }
...
;
# 786 "/home/rudy/workspace/Projects/rt-thread/src/thread.c"
rt_err_t rt_thread_resume(rt_thread_t thread)
{
    register rt_base_t temp;


    if (!(thread != (0))) { rt_assert_handler("thread != RT_NULL", __FUNCTION__, 791); };
    if (!(rt_object_get_type((rt_object_t)thread) == RT_Object_Class_Thread)) { rt_assert_handler("rt_object_get_type((rt_object_t)thread) == RT_Object_Class_Thread", __FUNCTION__, 792); };
...
void rt_thread_timeout(void *parameter)
{
    ...
    if (!(thread != (0))) { rt_assert_handler("thread != RT_NULL", __FUNCTION__, 836); };
    if (!((thread->stat & 0x07) == 0x02)) { rt_assert_handler("(thread->stat & RT_THREAD_STAT_MASK) == RT_THREAD_SUSPEND", __FUNCTION__, 837); };
    if (!(rt_object_get_type((rt_object_t)thread) == RT_Object_Class_Thread)) { rt_assert_handler("rt_object_get_type((rt_object_t)thread) == RT_Object_Class_Thread", __FUNCTION__, 838); };
...
;
# 863 "/home/rudy/workspace/Projects/rt-thread/src/thread.c"
rt_thread_t rt_thread_find(char *name)
{
    ...
    if (!(information != (0))) { rt_assert_handler("information != RT_NULL", __FUNCTION__, 875); };
    for (node = information->object_list.next;
         node != &(information->object_list);
         node = node->next)
    {
        object = ((struct rt_object *)((char *)(node) - (unsigned long)(&((struct rt_object *)0)->list)));
        if (rt_strncmp(object->name, name, 32) == 0)
        {
