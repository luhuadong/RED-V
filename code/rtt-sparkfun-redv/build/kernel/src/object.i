# 1 "/home/rudy/workspace/Projects/rt-thread/src/object.c"
...
# 1 "/home/rudy/workspace/Projects/rt-thread/src/object.c"
# 18 "/home/rudy/workspace/Projects/rt-thread/src/object.c"
...
# 19 "/home/rudy/workspace/Projects/rt-thread/src/object.c" 2
...
# 20 "/home/rudy/workspace/Projects/rt-thread/src/object.c" 2
# 28 "/home/rudy/workspace/Projects/rt-thread/src/object.c"
...
# 127 "/home/rudy/workspace/Projects/rt-thread/src/object.c"
void rt_object_attach_sethook(void (*hook)(struct rt_object *object))
{
...
# 156 "/home/rudy/workspace/Projects/rt-thread/src/object.c"
void rt_object_trytake_sethook(void (*hook)(struct rt_object *object))
{
    rt_object_trytake_hook = hook;
}
# 175 "/home/rudy/workspace/Projects/rt-thread/src/object.c"
void rt_object_take_sethook(void (*hook)(struct rt_object *object))
{
...
# 202 "/home/rudy/workspace/Projects/rt-thread/src/object.c"
void rt_system_object_init(void)
{
}
# 220 "/home/rudy/workspace/Projects/rt-thread/src/object.c"
struct rt_object_information *
rt_object_get_information(enum rt_object_class_type type)
{
    int index;
...
;
# 239 "/home/rudy/workspace/Projects/rt-thread/src/object.c"
int rt_object_get_length(enum rt_object_class_type type)
{
    int count = 0;
    rt_ubase_t level;
...
;
# 272 "/home/rudy/workspace/Projects/rt-thread/src/object.c"
int rt_object_get_pointers(enum rt_object_class_type type, rt_object_t *pointers, int maxlen)
{
    int index = 0;
    rt_ubase_t level;
...
;
# 311 "/home/rudy/workspace/Projects/rt-thread/src/object.c"
void rt_object_init(struct rt_object *object,
                    enum rt_object_class_type type,
                    const char *name)
{
    ...
    if (!(information != (0))) { rt_assert_handler("information != RT_NULL", __FUNCTION__, 324); };
            ...
            node = node->next)
    {
        ...
        if (obj)
        {
            if (!(obj != object)) { rt_assert_handler("obj != object", __FUNCTION__, 340); };
        }
    }
    ...
    rt_strncpy(object->name, name, 32);

    do { if ((rt_object_attach_hook) != (0)) rt_object_attach_hook (object); } while (0);


    temp = rt_hw_interrupt_disable();
# 365 "/home/rudy/workspace/Projects/rt-thread/src/object.c"
    {
...
void rt_object_detach(rt_object_t object)
{
    ...
    if (!(object != (0))) { rt_assert_handler("object != RT_NULL", __FUNCTION__, 385); };
...
# 411 "/home/rudy/workspace/Projects/rt-thread/src/object.c"
rt_object_t rt_object_allocate(enum rt_object_class_type type, const char *name)
{
    ...
    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 420); } } rt_hw_interrupt_enable(level); } while (0);


    information = rt_object_get_information(type);
    if (!(information != (0))) { rt_assert_handler("information != RT_NULL", __FUNCTION__, 424); };
    ...
    temp = rt_hw_interrupt_disable();
# 460 "/home/rudy/workspace/Projects/rt-thread/src/object.c"
    {
...
void rt_object_delete(rt_object_t object)
{
    ...
    if (!(object != (0))) { rt_assert_handler("object != RT_NULL", __FUNCTION__, 482); };
    if (!(!(object->type & RT_Object_Class_Static))) { rt_assert_handler("!(object->type & RT_Object_Class_Static)", __FUNCTION__, 483); };
...
# 513 "/home/rudy/workspace/Projects/rt-thread/src/object.c"
rt_bool_t rt_object_is_systemobject(rt_object_t object)
{

    if (!(object != (0))) { rt_assert_handler("object != RT_NULL", __FUNCTION__, 516); };
...
# 532 "/home/rudy/workspace/Projects/rt-thread/src/object.c"
rt_uint8_t rt_object_get_type(rt_object_t object)
{

    if (!(object != (0))) { rt_assert_handler("object != RT_NULL", __FUNCTION__, 535); };

    return object->type & ~RT_Object_Class_Static;
}
# 552 "/home/rudy/workspace/Projects/rt-thread/src/object.c"
rt_object_t rt_object_find(const char *name, rt_uint8_t type)
{
    ...
    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 564); } } rt_hw_interrupt_enable(level); } while (0);
