...
rt_hw_stack_init:
.LFB15:
	.file 1 "/home/rudy/workspace/Projects/rt-thread/libcpu/risc-v/common/cpuport.c"
	.loc 1 72 1
	.cfi_startproc
	addi	sp,sp,-48
	...
	j	.L2
.L3:
	.loc 1 85 30 discriminator 3
	lw	a5,-20(s0)
	slli	a5,a5,2
	lw	a4,-28(s0)
	add	a5,a4,a5
	.loc 1 85 34 discriminator 3
	li	a4,-559038464
	addi	a4,a4,-273
	sw	a4,0(a5)
	.loc 1 83 77 discriminator 3
	lw	a5,-20(s0)
	addi	a5,a5,1
	sw	a5,-20(s0)
.L2:
...
.LFE17:
	...
	.section	.rodata
	.align	2
	.type	__FUNCTION__.3122, @object
	.size	__FUNCTION__.3122, 19
__FUNCTION__.3122:
...
.Ldebug_macro0:
	...
	.byte	0x4
	.file 64 "/home/rudy/workspace/Projects/rt-thread/libcpu/risc-v/common/cpuport.h"
	.byte	0x3
	.byte	0xe
	.byte	0x40
	.byte	0x7
...
.Ldebug_macro53:
	...
	.4byte	.LASF1688
	.byte	0
	.section	.debug_macro,"G",@progbits,wm4.cpuport.h.12.4bb6d4411103d12353a8a8463a3af165,comdat
.Ldebug_macro54:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
.LASF1846:
	.string	"/home/rudy/workspace/Projects/rt-thread/bsp/red-v"
.LASF536:
...
.LASF1845:
	.string	"/home/rudy/workspace/Projects/rt-thread/libcpu/risc-v/common/cpuport.c"
.LASF484:
