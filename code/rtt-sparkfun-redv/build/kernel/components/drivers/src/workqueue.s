...
rt_work_init:
.LFB16:
	.file 2 "/home/rudy/workspace/Projects/rt-thread/components/drivers/include/ipc/workqueue.h"
	.loc 2 73 1
	.cfi_startproc
	addi	sp,sp,-32
	.cfi_def_cfa_offset 32
...
.LFB19:
	.file 3 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/workqueue.c"
	.loc 3 20 1
	.cfi_startproc
	addi	sp,sp,-48
...
.LFB20:
	...
	lw	a5,-20(s0)
	bne	a5,zero,.L18
	.loc 3 57 28 discriminator 1
	li	a2,57
	lla	a1,__FUNCTION__.3409
	lla	a0,.LC0
...
.LFE22:
	...
	.align	1
	.type	_workqueue_cancel_delayed_work, @function
...
.L30:
	...
	.cfi_endproc
.LFE23:
	.size	_workqueue_cancel_delayed_work, .-_workqueue_cancel_delayed_work
	.section	.rodata
	.align	2
.LC1:
	.string	"work"
	.text
	.align	1
	.type	_workqueue_submit_delayed_work, @function
...
.LFB24:
	...
	.loc 3 194 8
	beq	a5,zero,.L35
	.loc 3 194 32 discriminator 1
	lw	a5,-40(s0)
	lw	a5,88(a5)
	.loc 3 194 25 discriminator 1
	lw	a4,-36(s0)
	beq	a4,a5,.L35
	.loc 3 196 13
	li	a5,-10
...
.L35:
	...
	.loc 3 203 15
	lw	a0,-40(s0)
	call	_workqueue_cancel_delayed_work
	sw	a0,-20(s0)
	.loc 3 204 12
	lw	a5,-20(s0)
	blt	a5,zero,.L40
...
.L36:
	...
	.cfi_endproc
.LFE24:
	.size	_workqueue_submit_delayed_work, .-_workqueue_submit_delayed_work
	.align	1
...
.LFB27:
	...
	lw	a5,-20(s0)
	bne	a5,zero,.L47
	.loc 3 278 28 discriminator 1
	li	a2,278
	lla	a1,__FUNCTION__.3449
	lla	a0,.LC0
	call	rt_assert_handler
.L47:
	.loc 3 280 5
...
.LFB28:
	...
	lw	a5,-20(s0)
	bne	a5,zero,.L50
	.loc 3 288 28 discriminator 1
	li	a2,288
	lla	a1,__FUNCTION__.3454
	lla	a0,.LC0
	call	rt_assert_handler
.L50:
	.loc 3 289 8
...
.LFB29:
	...
	lw	a5,-20(s0)
	bne	a5,zero,.L54
	.loc 3 296 28 discriminator 1
	li	a2,296
	lla	a1,__FUNCTION__.3460
	lla	a0,.LC0
	call	rt_assert_handler
.L54:
	.loc 3 297 8
...
.L56:
	...
	lw	a1,-24(s0)
	lw	a0,-20(s0)
	call	_workqueue_submit_delayed_work
	mv	a5,a0
	j	.L58
.L57:
	.loc 3 310 16
...
.LFB30:
	...
	lw	a5,-36(s0)
	bne	a5,zero,.L60
	.loc 3 317 28 discriminator 1
	li	a2,317
	lla	a1,__FUNCTION__.3466
	lla	a0,.LC0
	call	rt_assert_handler
.L60:
	.loc 3 318 8
...
.LFB31:
	...
	lw	a5,-20(s0)
	bne	a5,zero,.L67
	.loc 3 345 28 discriminator 1
	li	a2,345
	lla	a1,__FUNCTION__.3471
	lla	a0,.LC0
	call	rt_assert_handler
.L67:
	.loc 3 346 8
...
.LFB32:
	...
	lw	a5,-36(s0)
	bne	a5,zero,.L72
	.loc 3 362 28 discriminator 1
	li	a2,362
	lla	a1,__FUNCTION__.3477
	lla	a0,.LC0
	call	rt_assert_handler
.L72:
	.loc 3 363 8
...
.LFB33:
	...
	lw	a5,-36(s0)
	bne	a5,zero,.L78
	.loc 3 384 28 discriminator 1
	li	a2,384
	lla	a1,__FUNCTION__.3483
	lla	a0,.LC0
	call	rt_assert_handler
.L78:
	.loc 3 386 5
	...
	j	.L79
.L80:
	.loc 3 389 14 discriminator 3
	lw	a5,-20(s0)
	lw	a5,0(a5)
	sw	a5,-24(s0)
	.loc 3 390 9 discriminator 3
	lw	a0,-20(s0)
	call	rt_list_remove
	.loc 3 387 74 discriminator 3
	lw	a5,-24(s0)
	sw	a5,-20(s0)
.L79:
	.loc 3 387 48 discriminator 1
	lw	a5,-36(s0)
	.loc 3 387 5 discriminator 1
	lw	a4,-20(s0)
	bne	a4,a5,.L80
	.loc 3 392 5
	call	rt_exit_critical
...
.LFE33:
	...
	.align	1
	.globl	rt_delayed_work_init
	.type	rt_delayed_work_init, @function
...
.LFB34:
	...
	.cfi_endproc
.LFE34:
	.size	rt_delayed_work_init, .-rt_delayed_work_init
	.section	.rodata
	.align	2
	.type	__FUNCTION__.3409, @object
	.size	__FUNCTION__.3409, 24
__FUNCTION__.3409:
	.string	"_workqueue_thread_entry"
	.align	2
	.type	__FUNCTION__.3449, @object
	.size	__FUNCTION__.3449, 21
__FUNCTION__.3449:
	.string	"rt_workqueue_destroy"
	.align	2
	.type	__FUNCTION__.3454, @object
	.size	__FUNCTION__.3454, 20
__FUNCTION__.3454:
	.string	"rt_workqueue_dowork"
	.align	2
	.type	__FUNCTION__.3460, @object
	.size	__FUNCTION__.3460, 25
__FUNCTION__.3460:
	.string	"rt_workqueue_submit_work"
	.align	2
	.type	__FUNCTION__.3466, @object
	.size	__FUNCTION__.3466, 27
__FUNCTION__.3466:
	.string	"rt_workqueue_critical_work"
	.align	2
	.type	__FUNCTION__.3471, @object
	.size	__FUNCTION__.3471, 25
__FUNCTION__.3471:
	.string	"rt_workqueue_cancel_work"
	.align	2
	.type	__FUNCTION__.3477, @object
	.size	__FUNCTION__.3477, 30
__FUNCTION__.3477:
	.string	"rt_workqueue_cancel_work_sync"
	.align	2
	.type	__FUNCTION__.3483, @object
	.size	__FUNCTION__.3483, 29
__FUNCTION__.3483:
	.string	"rt_workqueue_cancel_all_work"
	.text
.Letext0:
	.file 4 "/home/rudy/workspace/Projects/rt-thread/include/rtdef.h"
...
.Ldebug_macro0:
	...
	.4byte	.LASF1700
	.byte	0x4
	.file 69 "/home/rudy/workspace/Projects/rt-thread/components/drivers/include/ipc/waitqueue.h"
	.byte	0x3
	.byte	0x15
	.byte	0x45
	.byte	0x7
...
.LASF1978:
	.string	"/home/rudy/workspace/Projects/rt-thread/components/drivers/src/workqueue.c"
.LASF311:
...
.LASF1964:
	.string	"_workqueue_submit_delayed_work"
.LASF171:
...
.LASF1965:
	.string	"_workqueue_cancel_delayed_work"
.LASF1347:
