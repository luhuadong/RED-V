# 1 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringbuffer.c"
...
# 1 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringbuffer.c"
# 13 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringbuffer.c"
...
# 14 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringbuffer.c" 2
...
# 15 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringbuffer.c" 2
...
# 46 "/home/rudy/opt/FreedomStudio/SiFive/riscv64-unknown-elf-gcc-8.3.0-2020.04.1/riscv64-unknown-elf/include/strings.h" 3
...
# 16 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringbuffer.c" 2


# 17 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringbuffer.c"
...
void rt_ringbuffer_init(struct rt_ringbuffer *rb,
                        ...
                        rt_int16_t size)
{
    if (!(rb != (0))) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 33); };
    if (!(size > 0)) { rt_assert_handler("size > 0", __FUNCTION__, 34); };
                            ...
                            rt_uint16_t length)
{
    ...
    if (!(rb != (0))) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 55); };
                            ...
                            rt_uint16_t length)
{
    ...
    if (!(rb != (0))) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 104); };
                            ...
                            rt_uint16_t length)
{
    ...
    if (!(rb != (0))) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 158); };
...
rt_size_t rt_ringbuffer_putchar(struct rt_ringbuffer *rb, const rt_uint8_t ch)
{
    if (!(rb != (0))) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 201); };
...
rt_size_t rt_ringbuffer_putchar_force(struct rt_ringbuffer *rb, const rt_uint8_t ch)
{
    ...
    if (!(rb != (0))) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 233); };
...
rt_size_t rt_ringbuffer_getchar(struct rt_ringbuffer *rb, rt_uint8_t *ch)
{
    if (!(rb != (0))) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 266); };
...
void rt_ringbuffer_reset(struct rt_ringbuffer *rb)
{
    if (!(rb != (0))) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 315); };
...
struct rt_ringbuffer* rt_ringbuffer_create(rt_uint16_t size)
{
 ...
 if (!(size > 0)) { rt_assert_handler("size > 0", __FUNCTION__, 331); };
...
void rt_ringbuffer_destroy(struct rt_ringbuffer *rb)
{
    if (!(rb != (0))) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 355); };
