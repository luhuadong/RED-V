...
.LFE4:
	...
	.align	2
.LC0:
	.string	"queue != RT_NULL"
	.align	2
.LC1:
	.string	"(0x10000 % size) == 0"
	.text
	.align	1
...
rt_data_queue_init:
.LFB19:
	.file 2 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/dataqueue.c"
	.loc 2 29 1
	.cfi_startproc
	addi	sp,sp,-32
	.cfi_def_cfa_offset 32
	...
	lw	a5,-20(s0)
	bne	a5,zero,.L6
	.loc 2 30 28 discriminator 1
	li	a2,30
	lla	a1,__FUNCTION__.3405
	lla	a0,.LC0
...
.LFE19:
	...
	.align	2
.LC2:
	.string	"queue->magic == DATAQUEUE_MAGIC"
	.align	2
.LC3:
...
.LFB20:
	...
	addi	a5,a5,-498
	beq	a4,a5,.L11
	.loc 2 64 42 discriminator 1
	li	a2,64
	lla	a1,__FUNCTION__.3415
	lla	a0,.LC2
	call	rt_assert_handler
.L11:
	.loc 2 65 8
...
.LBB2:
	...
	.loc 2 82 69
	beq	a5,zero,.L16
	.loc 2 82 102 discriminator 1
	lla	a1,__FUNCTION__.3415
	lla	a0,.LC3
	call	rt_kprintf
	.loc 2 82 183 discriminator 1
	li	a2,82
	lla	a1,__FUNCTION__.3415
	lla	a0,.LC4
	call	rt_assert_handler
.L16:
	.loc 2 82 229 discriminator 5
	lw	a0,-32(s0)
	call	rt_hw_interrupt_enable
.LBE2:
	.loc 2 85 23 discriminator 5
	lw	a5,-28(s0)
	sw	zero,72(a5)
	.loc 2 88 9 discriminator 5
	lw	a0,-28(s0)
	call	rt_thread_suspend
	.loc 2 89 9 discriminator 5
	lw	a5,-36(s0)
	addi	a4,a5,20
	lw	a5,-28(s0)
	addi	a5,a5,44
	...
	.loc 2 91 21 discriminator 5
	lw	a5,-48(s0)
	.loc 2 91 12 discriminator 5
	ble	a5,zero,.L17
	.loc 2 94 13
	lw	a5,-28(s0)
	addi	a5,a5,104
...
.LFB21:
	...
	addi	a5,a5,-498
	beq	a4,a5,.L24
	.loc 2 154 42 discriminator 1
	li	a2,154
	lla	a1,__FUNCTION__.3430
	lla	a0,.LC2
	call	rt_assert_handler
.L24:
	.loc 2 155 8
...
.LBB3:
	...
	.loc 2 173 69
	beq	a5,zero,.L31
	.loc 2 173 102 discriminator 1
	lla	a1,__FUNCTION__.3430
	lla	a0,.LC3
	call	rt_kprintf
	.loc 2 173 183 discriminator 1
	li	a2,173
	lla	a1,__FUNCTION__.3430
	lla	a0,.LC4
	call	rt_assert_handler
.L31:
	.loc 2 173 230 discriminator 5
	lw	a0,-32(s0)
	call	rt_hw_interrupt_enable
.LBE3:
	.loc 2 176 23 discriminator 5
	lw	a5,-28(s0)
	sw	zero,72(a5)
	.loc 2 179 9 discriminator 5
	lw	a0,-28(s0)
	call	rt_thread_suspend
	.loc 2 180 9 discriminator 5
	lw	a5,-36(s0)
	addi	a4,a5,28
	lw	a5,-28(s0)
	addi	a5,a5,44
	...
	mv	a0,a4
	call	rt_list_insert_before
	.loc 2 182 21 discriminator 5
	lw	a5,-48(s0)
	.loc 2 182 12 discriminator 5
	ble	a5,zero,.L32
	.loc 2 185 13
	lw	a5,-28(s0)
	addi	a5,a5,104
...
.L30:
	...
	lw	a5,-24(s0)
	bne	a5,zero,.L38
	.loc 2 239 32 discriminator 1
	lw	a5,-36(s0)
	lw	a5,36(a5)
	.loc 2 239 23 discriminator 1
	beq	a5,zero,.L38
	.loc 2 241 14
	lw	a5,-36(s0)
	lw	a5,36(a5)
...
.LFB22:
	...
	addi	a5,a5,-498
	beq	a4,a5,.L42
	.loc 2 254 42 discriminator 1
	li	a2,254
	lla	a1,__FUNCTION__.3442
	lla	a0,.LC2
	call	rt_assert_handler
.L42:
	.loc 2 255 8
...
.Ldebug_macro0:
	...
	.byte	0x4
	.byte	0x4
	.file 64 "/home/rudy/workspace/Projects/rt-thread/components/drivers/include/rtdevice.h"
	.byte	0x3
	.byte	0xd
	.byte	0x40
	.byte	0x5
	.byte	0xd
	.4byte	.LASF1680
	.file 65 "/home/rudy/workspace/Projects/rt-thread/components/drivers/include/ipc/ringbuffer.h"
	.byte	0x3
	.byte	0x11
	.byte	0x41
	.byte	0x7
	...
	.byte	0x4
	.file 66 "/home/rudy/workspace/Projects/rt-thread/components/drivers/include/ipc/completion.h"
	.byte	0x3
	.byte	0x12
	.byte	0x42
	.byte	0x5
	...
	.byte	0x4
	.byte	0x4
	.file 73 "/home/rudy/workspace/Projects/rt-thread/include/rthw.h"
	.byte	0x3
	.byte	0xe
	.byte	0x49
	.byte	0x7
...
.LASF1958:
	.string	"/home/rudy/workspace/Projects/rt-thread/components/drivers/src/dataqueue.c"
.LASF872:
