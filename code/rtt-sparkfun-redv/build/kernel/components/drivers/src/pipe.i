# 1 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/pipe.c"
...
# 1 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/pipe.c"
# 11 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/pipe.c"
...
# 12 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/pipe.c" 2
...
# 13 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/pipe.c" 2
# 323 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/pipe.c"
...
rt_size_t rt_pipe_read (rt_device_t device, rt_off_t pos, void *buffer, rt_size_t count)
{
    ...
    {
        rt_set_errno(-
# 377 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/pipe.c" 3
                     22
# 377 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/pipe.c"
                           );
        return 0;
    }
    if (count == 0) return 0;
...
rt_size_t rt_pipe_write (rt_device_t device, rt_off_t pos, const void *buffer, rt_size_t count)
{
    ...
    {
        rt_set_errno(-
# 405 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/pipe.c" 3
                     22
# 405 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/pipe.c"
                           );
        return 0;
    }
    if (count == 0) return 0;
...
# 442 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/pipe.c"
rt_pipe_t *rt_pipe_create(const char *name, int bufsz)
{
    rt_pipe_t *pipe;
    rt_device_t dev;
    ...
    if (!(bufsz < 0xFFFF)) { rt_assert_handler("bufsz < 0xFFFF", __FUNCTION__, 456); };
    pipe->bufsz = bufsz;
...
int rt_pipe_delete(const char *name)
{
    ...
    if (device)
    {
        ...
        {
            result = -
# 519 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/pipe.c" 3
                     19
# 519 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/pipe.c"
                           ;
        }
    }
    else
    {
        result = -
# 524 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/pipe.c" 3
                 19
# 524 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/pipe.c"
                       ;
    }
