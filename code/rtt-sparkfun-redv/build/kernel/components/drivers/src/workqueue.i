# 1 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/workqueue.c"
...
# 1 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/workqueue.c"
# 11 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/workqueue.c"
...
# 12 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/workqueue.c" 2
...
# 14 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/workqueue.c" 2
...
static void _workqueue_thread_entry(void *parameter)
{
    ...
    if (!(queue != (0))) { rt_assert_handler("queue != RT_NULL", __FUNCTION__, 57); };
...
static rt_err_t _workqueue_cancel_delayed_work(struct rt_work *work)
{
    ...
    {
        ret = -
# 152 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/workqueue.c" 3
              22
# 152 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/workqueue.c"
                    ;
        goto __exit;
    }
...
rt_err_t rt_workqueue_destroy(struct rt_workqueue *queue)
{
    if (!(queue != (0))) { rt_assert_handler("queue != RT_NULL", __FUNCTION__, 278); };
...
rt_err_t rt_workqueue_dowork(struct rt_workqueue *queue, struct rt_work *work)
{
    if (!(queue != (0))) { rt_assert_handler("queue != RT_NULL", __FUNCTION__, 288); };
    if (!(work != (0))) { rt_assert_handler("work != RT_NULL", __FUNCTION__, 289); };
...
rt_err_t rt_workqueue_submit_work(struct rt_workqueue *queue, struct rt_work *work, rt_tick_t time)
{
    if (!(queue != (0))) { rt_assert_handler("queue != RT_NULL", __FUNCTION__, 296); };
    if (!(work != (0))) { rt_assert_handler("work != RT_NULL", __FUNCTION__, 297); };
...
{
    rt_base_t level;
    if (!(queue != (0))) { rt_assert_handler("queue != RT_NULL", __FUNCTION__, 317); };
    if (!(work != (0))) { rt_assert_handler("work != RT_NULL", __FUNCTION__, 318); };
...
rt_err_t rt_workqueue_cancel_work(struct rt_workqueue *queue, struct rt_work *work)
{
    if (!(queue != (0))) { rt_assert_handler("queue != RT_NULL", __FUNCTION__, 345); };
    if (!(work != (0))) { rt_assert_handler("work != RT_NULL", __FUNCTION__, 346); };
...
rt_err_t rt_workqueue_cancel_work_sync(struct rt_workqueue *queue, struct rt_work *work)
{
    ...
    if (!(queue != (0))) { rt_assert_handler("queue != RT_NULL", __FUNCTION__, 362); };
    if (!(work != (0))) { rt_assert_handler("work != RT_NULL", __FUNCTION__, 363); };
...
rt_err_t rt_workqueue_cancel_all_work(struct rt_workqueue *queue)
{
    ...
    if (!(queue != (0))) { rt_assert_handler("queue != RT_NULL", __FUNCTION__, 384); };
