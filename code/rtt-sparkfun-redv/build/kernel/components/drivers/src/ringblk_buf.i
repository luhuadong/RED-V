# 1 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c"
...
# 1 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c"
# 11 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c"
...
# 12 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c" 2
...
# 14 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c" 2
# 26 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c"
void rt_rbb_init(rt_rbb_t rbb, rt_uint8_t *buf, rt_size_t buf_size, rt_rbb_blk_t block_set, rt_size_t blk_max_num)
{
    rt_size_t i;

    if (!(rbb)) { rt_assert_handler("rbb", __FUNCTION__, 30); };
    if (!(buf)) { rt_assert_handler("buf", __FUNCTION__, 31); };
    if (!(block_set)) { rt_assert_handler("block_set", __FUNCTION__, 32); };
...
;
# 56 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c"
rt_rbb_t rt_rbb_create(rt_size_t buf_size, rt_size_t blk_max_num)
{
    rt_rbb_t rbb = 
# 58 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c" 3 4
                  ((void *)0)
# 58 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c"
                      ;
    rt_uint8_t *buf;
    rt_rbb_blk_t blk_set;
    ...
    {
        return 
# 65 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c" 3 4
              ((void *)0)
# 65 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c"
                  ;
    }
    ...
    if (!buf)
    {
        rt_free(rbb);
        return 
# 72 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c" 3 4
              ((void *)0)
# 72 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c"
                  ;
    }
    ...
    if (!blk_set)
    {
        ...
        rt_free(rbb);
        return 
# 80 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c" 3 4
              ((void *)0)
# 80 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c"
                  ;
    }
...
void rt_rbb_destroy(rt_rbb_t rbb)
{
    if (!(rbb)) { rt_assert_handler("rbb", __FUNCTION__, 96); };
...
static rt_rbb_blk_t find_empty_blk_in_set(rt_rbb_t rbb)
{
    ...
    if (!(rbb)) { rt_assert_handler("rbb", __FUNCTION__, 109); };
    ...
    return 
# 119 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c" 3 4
          ((void *)0)
# 119 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c"
              ;
}
# 133 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c"
rt_rbb_blk_t rt_rbb_blk_alloc(rt_rbb_t rbb, rt_size_t blk_size)
{
    rt_base_t level;
    rt_size_t empty1 = 0, empty2 = 0;
    rt_rbb_blk_t head, tail, new_rbb = 
# 137 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c" 3 4
                                      ((void *)0)
# 137 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c"
                                          ;

    if (!(rbb)) { rt_assert_handler("rbb", __FUNCTION__, 139); };
    if (!(blk_size < (1L << 24))) { rt_assert_handler("blk_size < (1L << 24)", __FUNCTION__, 140); };
        ...
        if (rt_slist_len(&rbb->blk_list) > 0)
        {
            ...
            if (head->buf <= tail->buf)
            {
                ...
                else
                {
                    ...
                    new_rbb = 
# 181 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c" 3 4
                             ((void *)0)
# 181 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c"
                                 ;
                }
            }
            else
            {
                ...
                else
                {
                    ...
                    new_rbb = 
# 205 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c" 3 4
                             ((void *)0)
# 205 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c"
                                 ;
                }
            }
        }
    ...
    {
        new_rbb = 
# 220 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c" 3 4
                 ((void *)0)
# 220 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c"
                     ;
    }
...
void rt_rbb_blk_put(rt_rbb_blk_t block)
{
    if (!(block)) { rt_assert_handler("block", __FUNCTION__, 236); };
    if (!(block->status == RT_RBB_BLK_INITED)) { rt_assert_handler("block->status == RT_RBB_BLK_INITED", __FUNCTION__, 237); };

    block->status = RT_RBB_BLK_PUT;
}
;
# 251 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c"
rt_rbb_blk_t rt_rbb_blk_get(rt_rbb_t rbb)
{
    rt_base_t level;
    rt_rbb_blk_t block = 
# 254 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c" 3 4
                        ((void *)0)
# 254 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c"
                            ;
    rt_slist_t *node;

    if (!(rbb)) { rt_assert_handler("rbb", __FUNCTION__, 257); };
    ...
    block = 
# 274 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c" 3 4
           ((void *)0)
# 274 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c"
               ;
...
;
# 291 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c"
rt_size_t rt_rbb_blk_size(rt_rbb_blk_t block)
{
    if (!(block)) { rt_assert_handler("block", __FUNCTION__, 293); };

    return block->size;
}
;
# 306 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c"
rt_uint8_t *rt_rbb_blk_buf(rt_rbb_blk_t block)
{
    if (!(block)) { rt_assert_handler("block", __FUNCTION__, 308); };
...
void rt_rbb_blk_free(rt_rbb_t rbb, rt_rbb_blk_t block)
{
    ...
    if (!(rbb)) { rt_assert_handler("rbb", __FUNCTION__, 324); };
    if (!(block)) { rt_assert_handler("block", __FUNCTION__, 325); };
    if (!(block->status != RT_RBB_BLK_UNUSED)) { rt_assert_handler("block->status != RT_RBB_BLK_UNUSED", __FUNCTION__, 326); };
...
;
# 362 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c"
rt_size_t rt_rbb_blk_queue_get(rt_rbb_t rbb, rt_size_t queue_data_len, rt_rbb_blk_queue_t blk_queue)
{
    rt_base_t level;
...
# 367 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c" 3 4
                             ((void *)0)
# 367 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c"
                                 , block;

    if (!(rbb)) { rt_assert_handler("rbb", __FUNCTION__, 369); };
    if (!(blk_queue)) { rt_assert_handler("blk_queue", __FUNCTION__, 370); };
    ...
    for (node = rt_slist_first(&rbb->blk_list); node; node = rt_slist_next(node))
    {
        if (!last_block)
        {
            ...
            else
            {
                ...
                last_block = 
# 391 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c" 3 4
                            ((void *)0)
# 391 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c"
                                ;
                continue;
            }
        }
...
;
# 433 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c"
rt_size_t rt_rbb_blk_queue_len(rt_rbb_blk_queue_t blk_queue)
{
    rt_size_t i, data_total_size = 0;

    if (!(blk_queue)) { rt_assert_handler("blk_queue", __FUNCTION__, 437); };
...
;
# 455 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c"
rt_uint8_t *rt_rbb_blk_queue_buf(rt_rbb_blk_queue_t blk_queue)
{
    if (!(blk_queue)) { rt_assert_handler("blk_queue", __FUNCTION__, 457); };
...
void rt_rbb_blk_queue_free(rt_rbb_t rbb, rt_rbb_blk_queue_t blk_queue)
{
    ...
    if (!(rbb)) { rt_assert_handler("rbb", __FUNCTION__, 473); };
    if (!(blk_queue)) { rt_assert_handler("blk_queue", __FUNCTION__, 474); };
...
;
# 491 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c"
rt_size_t rt_rbb_next_blk_queue_len(rt_rbb_t rbb)
{
    rt_base_t level;
    ...
    rt_slist_t *node;
    rt_rbb_blk_t last_block = 
# 496 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c" 3 4
                             ((void *)0)
# 496 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c"
                                 , block;

    if (!(rbb)) { rt_assert_handler("rbb", __FUNCTION__, 498); };
    ...
    for (node = rt_slist_first(&rbb->blk_list); node; node = rt_slist_next(node))
    {
        if (!last_block)
        {
            ...
            if (last_block->status != RT_RBB_BLK_PUT)
            {
                ...
                last_block = 
# 513 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c" 3 4
                            ((void *)0)
# 513 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c"
                                ;
                continue;
            }
        }
...
;
# 548 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringblk_buf.c"
rt_size_t rt_rbb_get_buf_size(rt_rbb_t rbb)
{
    if (!(rbb)) { rt_assert_handler("rbb", __FUNCTION__, 550); };
