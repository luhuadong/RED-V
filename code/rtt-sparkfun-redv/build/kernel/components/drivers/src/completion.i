# 1 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/completion.c"
...
# 1 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/completion.c"
# 11 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/completion.c"
...
# 12 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/completion.c" 2
...
# 14 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/completion.c" 2
...
{
    rt_base_t level;
    if (!(completion != (0))) { rt_assert_handler("completion != RT_NULL", __FUNCTION__, 21); };
                            ...
                            rt_int32_t timeout)
{
    ...
    rt_base_t level;
    rt_thread_t thread;
    if (!(completion != (0))) { rt_assert_handler("completion != RT_NULL", __FUNCTION__, 36); };
    ...
    if (completion->flag != 1)
    {
        ...
        if (!(rt_list_isempty(&(completion->suspended_list)))) { rt_assert_handler("rt_list_isempty(&(completion->suspended_list))", __FUNCTION__, 45); };
...
{
    rt_base_t level;
    if (!(completion != (0))) { rt_assert_handler("completion != RT_NULL", __FUNCTION__, 100); };
