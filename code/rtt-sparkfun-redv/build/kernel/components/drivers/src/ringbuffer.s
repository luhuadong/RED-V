...
.LFB20:
	.file 1 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringbuffer.c"
	.loc 1 18 1
	.cfi_startproc
	addi	sp,sp,-32
...
.LFB24:
	...
	lw	a5,-36(s0)
	bne	a5,zero,.L22
	.loc 1 158 25 discriminator 1
	li	a2,158
	lla	a1,__FUNCTION__.3556
	lla	a0,.LC0
	call	rt_assert_handler
.L22:
	.loc 1 161 12
...
.LFB27:
	...
	lw	a5,-20(s0)
	bne	a5,zero,.L40
	.loc 1 266 25 discriminator 1
	li	a2,266
	lla	a1,__FUNCTION__.3572
	lla	a0,.LC0
	call	rt_assert_handler
.L40:
	.loc 1 269 10
...
.LFB29:
	...
	lw	a5,-20(s0)
	bne	a5,zero,.L53
	.loc 1 315 25 discriminator 1
	li	a2,315
	lla	a1,__FUNCTION__.3583
	lla	a0,.LC0
	call	rt_assert_handler
.L53:
	.loc 1 317 21
...
.LFB30:
	...
	lhu	a5,-34(s0)
	bne	a5,zero,.L55
	.loc 1 331 21 discriminator 1
	li	a2,331
	lla	a1,__FUNCTION__.3589
	lla	a0,.LC1
	call	rt_assert_handler
.L55:
	.loc 1 333 10
...
.LFB31:
	...
	lw	a5,-20(s0)
	bne	a5,zero,.L62
	.loc 1 355 25 discriminator 1
	li	a2,355
	lla	a1,__FUNCTION__.3594
	lla	a0,.LC0
	call	rt_assert_handler
.L62:
	.loc 1 357 15
...
.LFE31:
	...
	.size	__FUNCTION__.3535, 19
__FUNCTION__.3535:
	.string	"rt_ringbuffer_init"
	.align	2
	.type	__FUNCTION__.3542, @object
	.size	__FUNCTION__.3542, 18
__FUNCTION__.3542:
	.string	"rt_ringbuffer_put"
	.align	2
	.type	__FUNCTION__.3549, @object
	.size	__FUNCTION__.3549, 24
__FUNCTION__.3549:
	.string	"rt_ringbuffer_put_force"
	.align	2
	.type	__FUNCTION__.3556, @object
	.size	__FUNCTION__.3556, 18
__FUNCTION__.3556:
	.string	"rt_ringbuffer_get"
	.align	2
	.type	__FUNCTION__.3561, @object
	.size	__FUNCTION__.3561, 22
__FUNCTION__.3561:
	.string	"rt_ringbuffer_putchar"
	.align	2
	.type	__FUNCTION__.3567, @object
	.size	__FUNCTION__.3567, 28
__FUNCTION__.3567:
	.string	"rt_ringbuffer_putchar_force"
	.align	2
	.type	__FUNCTION__.3572, @object
	.size	__FUNCTION__.3572, 22
__FUNCTION__.3572:
	.string	"rt_ringbuffer_getchar"
	.align	2
	.type	__FUNCTION__.3583, @object
	.size	__FUNCTION__.3583, 20
__FUNCTION__.3583:
	.string	"rt_ringbuffer_reset"
	.align	2
	.type	__FUNCTION__.3589, @object
	.size	__FUNCTION__.3589, 21
__FUNCTION__.3589:
	.string	"rt_ringbuffer_create"
	.align	2
	.type	__FUNCTION__.3594, @object
	.size	__FUNCTION__.3594, 22
__FUNCTION__.3594:
...
.Letext0:
	...
	.file 11 "/home/rudy/workspace/Projects/rt-thread/components/drivers/include/ipc/ringbuffer.h"
...
.LASF1914:
	.string	"/home/rudy/workspace/Projects/rt-thread/components/drivers/src/ringbuffer.c"
.LASF1302:
