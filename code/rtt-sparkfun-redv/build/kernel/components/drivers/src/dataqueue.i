# 1 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/dataqueue.c"
...
# 1 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/dataqueue.c"
# 12 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/dataqueue.c"
...
# 13 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/dataqueue.c" 2
...
# 14 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/dataqueue.c" 2
...
# 15 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/dataqueue.c" 2
...
rt_data_queue_init(struct rt_data_queue *queue,
                   ...
                   void (*evt_notify)(struct rt_data_queue *queue, rt_uint32_t event))
{
    if (!(queue != (0))) { rt_assert_handler("queue != RT_NULL", __FUNCTION__, 30); };
    if (!((0x10000 % size) == 0)) { rt_assert_handler("(0x10000 % size) == 0", __FUNCTION__, 31); };
                            ...
                            rt_int32_t timeout)
{
    ...
    if (!(queue->magic == 0xbead0e0e)) { rt_assert_handler("queue->magic == DATAQUEUE_MAGIC", __FUNCTION__, 64); };
    if (!(queue != (0))) { rt_assert_handler("queue != RT_NULL", __FUNCTION__, 65); };
                           ...
                           rt_int32_t timeout)
{
    ...
    if (!(queue->magic == 0xbead0e0e)) { rt_assert_handler("queue->magic == DATAQUEUE_MAGIC", __FUNCTION__, 154); };
    if (!(queue != (0))) { rt_assert_handler("queue != RT_NULL", __FUNCTION__, 155); };
    if (!(data_ptr != (0))) { rt_assert_handler("data_ptr != RT_NULL", __FUNCTION__, 156); };
    if (!(size != (0))) { rt_assert_handler("size != RT_NULL", __FUNCTION__, 157); };
    ...
    while (queue->get_index == queue->put_index)
    {
        ...
        do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 173); } } rt_hw_interrupt_enable(level); } while (0);
                            ...
                            rt_size_t *size)
{
    ...
    if (!(queue->magic == 0xbead0e0e)) { rt_assert_handler("queue->magic == DATAQUEUE_MAGIC", __FUNCTION__, 254); };
    if (!(queue != (0))) { rt_assert_handler("queue != RT_NULL", __FUNCTION__, 255); };
...
void rt_data_queue_reset(struct rt_data_queue *queue)
{
    ...
    if (!(queue->magic == 0xbead0e0e)) { rt_assert_handler("queue->magic == DATAQUEUE_MAGIC", __FUNCTION__, 280); };
...
rt_err_t rt_data_queue_deinit(struct rt_data_queue *queue)
{
    ...
    if (!(queue->magic == 0xbead0e0e)) { rt_assert_handler("queue->magic == DATAQUEUE_MAGIC", __FUNCTION__, 342); };
    if (!(queue != (0))) { rt_assert_handler("queue != RT_NULL", __FUNCTION__, 343); };
