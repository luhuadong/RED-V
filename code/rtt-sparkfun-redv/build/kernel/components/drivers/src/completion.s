...
rt_completion_init:
.LFB19:
	.file 2 "/home/rudy/workspace/Projects/rt-thread/components/drivers/src/completion.c"
	.loc 2 19 1
	.cfi_startproc
	addi	sp,sp,-48
...
.LFE19:
	...
	.align	2
.LC1:
	.string	"rt_list_isempty(&(completion->suspended_list))"
	.align	2
.LC2:
...
.LBB2:
	...
	.loc 2 64 73
	beq	a5,zero,.L13
	.loc 2 64 106 discriminator 1
	lla	a1,__FUNCTION__.3407
	lla	a0,.LC2
	call	rt_kprintf
	.loc 2 64 187 discriminator 1
	li	a2,64
	lla	a1,__FUNCTION__.3407
	lla	a0,.LC3
	call	rt_assert_handler
.L13:
	.loc 2 64 233 discriminator 5
	lw	a0,-32(s0)
	call	rt_hw_interrupt_enable
.LBE2:
	.loc 2 67 25 discriminator 5
	lw	a5,-40(s0)
	.loc 2 67 16 discriminator 5
	ble	a5,zero,.L14
	.loc 2 70 17
	lw	a5,-28(s0)
	addi	a5,a5,104
...
.LFB21:
	...
	lw	a5,-36(s0)
	bne	a5,zero,.L17
	.loc 2 100 33 discriminator 1
	li	a2,100
	lla	a1,__FUNCTION__.3414
	lla	a0,.LC0
	call	rt_assert_handler
.L17:
	.loc 2 102 19
...
.LFE21:
	...
	.section	.rodata
	.align	2
	.type	__FUNCTION__.3399, @object
	.size	__FUNCTION__.3399, 19
__FUNCTION__.3399:
	.string	"rt_completion_init"
	.align	2
	.type	__FUNCTION__.3407, @object
	.size	__FUNCTION__.3407, 19
__FUNCTION__.3407:
	.string	"rt_completion_wait"
	.align	2
	.type	__FUNCTION__.3414, @object
	.size	__FUNCTION__.3414, 19
__FUNCTION__.3414:
...
.Letext0:
	...
	.file 12 "/home/rudy/workspace/Projects/rt-thread/components/drivers/include/ipc/completion.h"
...
.LASF1942:
	.string	"/home/rudy/workspace/Projects/rt-thread/components/drivers/src/completion.c"
.LASF523:
