# 1 "/home/rudy/workspace/Projects/rt-thread/components/drivers/serial/serial.c"
...
# 1 "/home/rudy/workspace/Projects/rt-thread/components/drivers/serial/serial.c"
# 29 "/home/rudy/workspace/Projects/rt-thread/components/drivers/serial/serial.c"
...
# 30 "/home/rudy/workspace/Projects/rt-thread/components/drivers/serial/serial.c" 2
...
# 32 "/home/rudy/workspace/Projects/rt-thread/components/drivers/serial/serial.c" 2

#define DBG_TAG "UART"
#define DBG_LVL DBG_INFO
# 1 "/home/rudy/workspace/Projects/rt-thread/include/rtdbg.h" 1
# 31 "/home/rudy/workspace/Projects/rt-thread/include/rtdbg.h"
#define RT_DBG_H__ 
# 41 "/home/rudy/workspace/Projects/rt-thread/include/rtdbg.h"
#define DBG_ENABLE 
...
#define DBG_COLOR 
# 55 "/home/rudy/workspace/Projects/rt-thread/include/rtdbg.h"
#define DBG_ERROR 0
...
# 75 "/home/rudy/workspace/Projects/rt-thread/include/rtdbg.h"
#define DBG_LEVEL DBG_LVL
# 96 "/home/rudy/workspace/Projects/rt-thread/include/rtdbg.h"
...
# 114 "/home/rudy/workspace/Projects/rt-thread/include/rtdbg.h"
...
# 129 "/home/rudy/workspace/Projects/rt-thread/include/rtdbg.h"
...
# 144 "/home/rudy/workspace/Projects/rt-thread/include/rtdbg.h"
#define dbg_raw(...) rt_kprintf(__VA_ARGS__);
# 158 "/home/rudy/workspace/Projects/rt-thread/include/rtdbg.h"
#define LOG_D(...) 
...
# 36 "/home/rudy/workspace/Projects/rt-thread/components/drivers/serial/serial.c" 2
# 208 "/home/rudy/workspace/Projects/rt-thread/components/drivers/serial/serial.c"
static __inline int _serial_poll_rx(struct rt_serial_device *serial, rt_uint8_t *data, int length)
{
    int ch;
    int size;

    if (!(serial != (0))) { rt_assert_handler("serial != RT_NULL", __FUNCTION__, 213); };
    size = length;
...
{
    int size;
    if (!(serial != (0))) { rt_assert_handler("serial != RT_NULL", __FUNCTION__, 233); };
...
static __inline int _serial_int_rx(struct rt_serial_device *serial, rt_uint8_t *data, int length)
{
    ...
    if (!(serial != (0))) { rt_assert_handler("serial != RT_NULL", __FUNCTION__, 264); };
    size = length;

    rx_fifo = (struct rt_serial_rx_fifo*) serial->serial_rx;
    if (!(rx_fifo != (0))) { rt_assert_handler("rx_fifo != RT_NULL", __FUNCTION__, 268); };
...
static __inline int _serial_int_tx(struct rt_serial_device *serial, const rt_uint8_t *data, int length)
{
    ...
    if (!(serial != (0))) { rt_assert_handler("serial != RT_NULL", __FUNCTION__, 312); };

    size = length;
    tx = (struct rt_serial_tx_fifo*) serial->serial_tx;
    if (!(tx != (0))) { rt_assert_handler("tx != RT_NULL", __FUNCTION__, 316); };
...
static void _serial_check_buffer_size(void)
{
    ...
    if (already_output == 0)
    {
        ...
        do { rt_kprintf("\033[""33""m[" "W" "/" "UART" "] "); rt_kprintf("Warning: There is no enough buffer for saving data," " please increase the RT_SERIAL_RB_BUFSZ option."); rt_kprintf("\033[0m\n"); } while (0)
                                                                ;
...
static rt_size_t _serial_fifo_calc_recved_len(struct rt_serial_device *serial)
{
    ...
    if (!(rx_fifo != (0))) { rt_assert_handler("rx_fifo != RT_NULL", __FUNCTION__, 364); };
...
# 392 "/home/rudy/workspace/Projects/rt-thread/components/drivers/serial/serial.c"
...
static void rt_dma_recv_update_get_index(struct rt_serial_device *serial, rt_size_t len)
{
    ...
    if (!(rx_fifo != (0))) { rt_assert_handler("rx_fifo != RT_NULL", __FUNCTION__, 407); };
    if (!(len <= rt_dma_calc_recved_len(serial))) { rt_assert_handler("len <= rt_dma_calc_recved_len(serial)", __FUNCTION__, 408); };
...
static void rt_dma_recv_update_put_index(struct rt_serial_device *serial, rt_size_t len)
{
    ...
    if (!(rx_fifo != (0))) { rt_assert_handler("rx_fifo != RT_NULL", __FUNCTION__, 429); };
...
static __inline int _serial_dma_rx(struct rt_serial_device *serial, rt_uint8_t *data, int length)
{
    ...
    if (!((serial != (0)) && (data != (0)))) { rt_assert_handler("(serial != RT_NULL) && (data != RT_NULL)", __FUNCTION__, 474); };
    ...
    if (serial->config.bufsz == 0)
    {
        ...
        if (!(rx_dma != (0))) { rt_assert_handler("rx_dma != RT_NULL", __FUNCTION__, 484); };

        if (rx_dma->activated != 1)
        {
            rx_dma->activated = 1;
            if (!(serial->ops->dma_transmit != (0))) { rt_assert_handler("serial->ops->dma_transmit != RT_NULL", __FUNCTION__, 489); };
    ...
    else
    {
        ...
        if (!(rx_fifo != (0))) { rt_assert_handler("rx_fifo != RT_NULL", __FUNCTION__, 505); };
...
static rt_err_t rt_serial_init(struct rt_device *dev)
{
    ...
    if (!(dev != (0))) { rt_assert_handler("dev != RT_NULL", __FUNCTION__, 571); };
...
static rt_err_t rt_serial_open(struct rt_device *dev, rt_uint16_t oflag)
{
    ...
    if (!(dev != (0))) { rt_assert_handler("dev != RT_NULL", __FUNCTION__, 590); };
    serial = (struct rt_serial_device *)dev;
    ...
    if (serial->serial_rx == (0))
    {
        if (oflag & 0x100)
        {
            ...
            rx_fifo = (struct rt_serial_rx_fifo*) rt_malloc (sizeof(struct rt_serial_rx_fifo) +
                serial->config.bufsz);
            if (!(rx_fifo != (0))) { rt_assert_handler("rx_fifo != RT_NULL", __FUNCTION__, 621); };
        ...
        else if (oflag & 0x200)
        {
            if (serial->config.bufsz == 0) {
                ...
                if (!(rx_dma != (0))) { rt_assert_handler("rx_dma != RT_NULL", __FUNCTION__, 640); };
                rx_dma->activated = 0;
                ...
                rx_fifo = (struct rt_serial_rx_fifo*) rt_malloc (sizeof(struct rt_serial_rx_fifo) +
                    serial->config.bufsz);
                if (!(rx_fifo != (0))) { rt_assert_handler("rx_fifo != RT_NULL", __FUNCTION__, 649); };
                rx_fifo->buffer = (rt_uint8_t*) (rx_fifo + 1);
                rt_memset(rx_fifo->buffer, 0, serial->config.bufsz);
                rx_fifo->put_index = 0;
                rx_fifo->get_index = 0;
    ...
    if (serial->serial_tx == (0))
    {
        if (oflag & 0x400)
        {
            ...
            if (!(tx_fifo != (0))) { rt_assert_handler("tx_fifo != RT_NULL", __FUNCTION__, 684); };
        ...
        else if (oflag & 0x800)
        {
            ...
            if (!(tx_dma != (0))) { rt_assert_handler("tx_dma != RT_NULL", __FUNCTION__, 699); };
            tx_dma->activated = 0;
            ...
            serial->ops->control(serial, 0x03, (void *)0x800);
        }
...
static rt_err_t rt_serial_close(struct rt_device *dev)
{
    ...
    if (!(dev != (0))) { rt_assert_handler("dev != RT_NULL", __FUNCTION__, 735); };
    serial = (struct rt_serial_device *)dev;
    ...
    if (dev->open_flag & 0x100)
    {
        ...
        rx_fifo = (struct rt_serial_rx_fifo*)serial->serial_rx;
        if (!(rx_fifo != (0))) { rt_assert_handler("rx_fifo != RT_NULL", __FUNCTION__, 746); };
    ...
    else if (dev->open_flag & 0x200)
    {
        if (serial->config.bufsz == 0) {
            ...
            rx_dma = (struct rt_serial_rx_dma*)serial->serial_rx;
            if (!(rx_dma != (0))) { rt_assert_handler("rx_dma != RT_NULL", __FUNCTION__, 762); };
            ...
            rx_fifo = (struct rt_serial_rx_fifo*)serial->serial_rx;
            if (!(rx_fifo != (0))) { rt_assert_handler("rx_fifo != RT_NULL", __FUNCTION__, 769); };
    ...
    if (dev->open_flag & 0x400)
    {
        ...
        if (!(tx_fifo != (0))) { rt_assert_handler("tx_fifo != RT_NULL", __FUNCTION__, 786); };
    ...
    else if (dev->open_flag & 0x800)
    {
        ...
        tx_dma = (struct rt_serial_tx_dma*)serial->serial_tx;
        if (!(tx_dma != (0))) { rt_assert_handler("tx_dma != RT_NULL", __FUNCTION__, 801); };
        ...
        serial->ops->control(serial, 0x11, (void *) 0x800);
    }
                                ...
                                rt_size_t size)
{
    ...
    if (!(dev != (0))) { rt_assert_handler("dev != RT_NULL", __FUNCTION__, 827); };
    if (size == 0) return 0;
                                 ...
                                 rt_size_t size)
{
    ...
    if (!(dev != (0))) { rt_assert_handler("dev != RT_NULL", __FUNCTION__, 853); };
    if (size == 0) return 0;
...
# 971 "/home/rudy/workspace/Projects/rt-thread/components/drivers/serial/serial.c"
                                  ...
                                  void *args)
{
    ...
    if (!(dev != (0))) { rt_assert_handler("dev != RT_NULL", __FUNCTION__, 978); };
    serial = (struct rt_serial_device *)dev;
    ...
    switch (cmd)
    {
        ...
        case 0x03:
            ...
            break;
# 1119 "/home/rudy/workspace/Projects/rt-thread/components/drivers/serial/serial.c"
        default :
...
# 1143 "/home/rudy/workspace/Projects/rt-thread/components/drivers/serial/serial.c"
rt_err_t rt_hw_serial_register(struct rt_serial_device *serial,
                               const char *name,
                               rt_uint32_t flag,
                               void *data)
{
    ...
    if (!(serial != (0))) { rt_assert_handler("serial != RT_NULL", __FUNCTION__, 1150); };
...
void rt_hw_serial_isr(struct rt_serial_device *serial, int event)
{
    switch (event & 0xff)
    {
        case 0x01:
        {
            ...
            rx_fifo = (struct rt_serial_rx_fifo*)serial->serial_rx;
            if (!(rx_fifo != (0))) { rt_assert_handler("rx_fifo != RT_NULL", __FUNCTION__, 1194); };
        ...
        case 0x03:
        {
            ...
            if (serial->config.bufsz == 0)
            {
                ...
                rx_dma = (struct rt_serial_rx_dma*) serial->serial_rx;
                if (!(rx_dma != (0))) { rt_assert_handler("rx_dma != RT_NULL", __FUNCTION__, 1291); };

                if (!(serial->parent.rx_indicate != (0))) { rt_assert_handler("serial->parent.rx_indicate != RT_NULL", __FUNCTION__, 1293); };
