# 1 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c"
...
# 1 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c"
# 21 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c"
...
# 22 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c" 2
...
# 26 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c" 2
# 1 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.h" 1
# 12 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.h"
#define __SHELL_H__ 
# 27 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.h"
#define FINSH_OPTION_ECHO 0x01

#define FINSH_PROMPT finsh_get_prompt()
const char* finsh_get_prompt(void);
int finsh_set_prompt(const char * prompt);
# 55 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.h"
enum input_stat
{
    WAIT_NORMAL,
    WAIT_SPEC_KEY,
...
# 27 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c" 2


# 1 "/home/rudy/workspace/Projects/rt-thread/components/finsh/msh.h" 1
# 12 "/home/rudy/workspace/Projects/rt-thread/components/finsh/msh.h"
#define __M_SHELL__ 
...
# 30 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c" 2
# 46 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c"
struct finsh_syscall *_syscall_table_begin = 
# 46 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c" 3 4
                                             ((void *)0)
# 46 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c"
                                                 ;
struct finsh_syscall *_syscall_table_end = 
# 47 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c" 3 4
                                             ((void *)0)
# 47 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c"
                                                 ;
struct finsh_sysvar *_sysvar_table_begin = 
# 48 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c" 3 4
                                             ((void *)0)
# 48 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c"
                                                 ;
struct finsh_sysvar *_sysvar_table_end = 
# 49 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c" 3 4
                                             ((void *)0)
# 49 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c"
                                                 ;


struct finsh_shell *shell;
static char *finsh_prompt_custom = (0);
# 78 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c"
int finsh_set_prompt(const char * prompt)
{
...
#define _PROMPT "finsh "
    ...
    if (msh_is_used()) strcpy(finsh_prompt, "msh ");
    else

        strcpy(finsh_prompt, "finsh ");
...
# 146 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c"
rt_uint32_t finsh_get_prompt_mode(void)
{
    if (!(shell != (0))) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 148); };
    return shell->prompt_mode;
}
# 161 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c"
void finsh_set_prompt_mode(rt_uint32_t prompt_mode)
{
    if (!(shell != (0))) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 163); };
...
static int finsh_getchar(void)
{
    ...
    if (!(shell != (0))) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 175); };
...
{
    if (!(shell != (0))) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 190); };
...
# 205 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c"
void finsh_set_device(const char *device_name)
{
    rt_device_t dev = (0);

    if (!(shell != (0))) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 209); };
...
# 246 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c"
const char *finsh_get_device()
{
    if (!(shell != (0))) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 248); };
    return shell->device->parent.name;
}
# 262 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c"
void finsh_set_echo(rt_uint32_t echo)
{
    if (!(shell != (0))) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 264); };
    shell->echo_mode = (rt_uint8_t)echo;
}
# 275 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c"
rt_uint32_t finsh_get_echo()
{
    if (!(shell != (0))) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 277); };

    return shell->echo_mode;
}
# 373 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c"
...
# 441 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c"
static rt_bool_t shell_handle_history(struct finsh_shell *shell)
{
# 452 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c"
    rt_kprintf("\033[2K\r");
    ...
    if (shell->line_position != 0)
    {
        ...
        if (shell->history_count >= 5)
        {
            ...
            if (memcmp(&shell->cmd_history[5 - 1], shell->line, 80))
            {
                ...
                memset(&shell->cmd_history[index][0], 0, 80);
        ...
        else
        {
            ...
            if (shell->history_count == 0 || memcmp(&shell->cmd_history[shell->history_count - 1], shell->line, 80))
            {
                ...
                memset(&shell->cmd_history[shell->history_count][0], 0, 80);
...
void finsh_thread_entry(void *parameter)
{
    ...
    shell->echo_mode = 1;
# 517 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c"
    if (shell->device == (0))
    {
...
# 540 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c"
...
# 557 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c"
        if (ch == 0x1b)
        {
        ...
        if (ch == '\r' || ch == '\n')
        {
            ...
            {
# 716 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c"
            }
...
# 814 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c"
int finsh_system_init(void)
{
    rt_err_t result = 0;
    rt_thread_t tid;
# 836 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c"
...
# 868 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c"
    ...
    tid = rt_thread_create("tshell",
                           ...
                           4096, 20, 10);
# 887 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c"
    rt_sem_init(&(shell->rx_sem), "shrx", 0, 0);
    finsh_set_prompt_mode(1);

    if (tid != 
# 890 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c" 3 4
              ((void *)0) 
# 890 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.c"
                   && result == 0)
