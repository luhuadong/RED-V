# 1 "/home/rudy/workspace/Projects/rt-thread/components/finsh/msh.c"
...
# 1 "/home/rudy/workspace/Projects/rt-thread/components/finsh/msh.c"
# 12 "/home/rudy/workspace/Projects/rt-thread/components/finsh/msh.c"
...
# 13 "/home/rudy/workspace/Projects/rt-thread/components/finsh/msh.c" 2
...
# 17 "/home/rudy/workspace/Projects/rt-thread/components/finsh/msh.c" 2
...
# 18 "/home/rudy/workspace/Projects/rt-thread/components/finsh/msh.c" 2
...
# 1 "/home/rudy/workspace/Projects/rt-thread/components/finsh/finsh.h" 1
# 16 "/home/rudy/workspace/Projects/rt-thread/components/finsh/shell.h" 2
...
# 19 "/home/rudy/workspace/Projects/rt-thread/components/finsh/msh.c" 2
# 32 "/home/rudy/workspace/Projects/rt-thread/components/finsh/msh.c"
...
# 68 "/home/rudy/workspace/Projects/rt-thread/components/finsh/msh.c"
...
const char __fsym___cmd_help_name[] __attribute__((section(".rodata.name"))) = "__cmd_help"; const char __fsym___cmd_help_desc[] __attribute__((section(".rodata.name"))) = "RT-Thread shell help."; __attribute__((used)) const struct finsh_syscall __fsym___cmd_help __attribute__((section("FSymTab")))= { __fsym___cmd_help_name, __fsym___cmd_help_desc, (syscall_func)&msh_help };;
...
const char __fsym___cmd_ps_name[] __attribute__((section(".rodata.name"))) = "__cmd_ps"; const char __fsym___cmd_ps_desc[] __attribute__((section(".rodata.name"))) = "List threads in the system."; __attribute__((used)) const struct finsh_syscall __fsym___cmd_ps __attribute__((section("FSymTab")))= { __fsym___cmd_ps_name, __fsym___cmd_ps_desc, (syscall_func)&cmd_ps };;
...
const char __fsym___cmd_free_name[] __attribute__((section(".rodata.name"))) = "__cmd_free"; const char __fsym___cmd_free_desc[] __attribute__((section(".rodata.name"))) = "Show the memory usage in the system."; __attribute__((used)) const struct finsh_syscall __fsym___cmd_free __attribute__((section("FSymTab")))= { __fsym___cmd_free_name, __fsym___cmd_free_desc, (syscall_func)&cmd_free };;
...
# 303 "/home/rudy/workspace/Projects/rt-thread/components/finsh/msh.c"
static int _msh_exec_cmd(char *cmd, rt_size_t length, int *retp)
{
    ...
    if (!(cmd)) { rt_assert_handler("cmd", __FUNCTION__, 310); };
    if (!(retp)) { rt_assert_handler("retp", __FUNCTION__, 311); };
...
# 372 "/home/rudy/workspace/Projects/rt-thread/components/finsh/msh.c"
int msh_exec(char *cmd, rt_size_t length)
{
    int cmd_ret;
...
# 418 "/home/rudy/workspace/Projects/rt-thread/components/finsh/msh.c"
    {
        char *tcmd;
        tcmd = cmd;
        while (*tcmd != ' ' && *tcmd != '\0')
...
# 567 "/home/rudy/workspace/Projects/rt-thread/components/finsh/msh.c"
void msh_auto_complete(char *prefix)
{
...
# 611 "/home/rudy/workspace/Projects/rt-thread/components/finsh/msh.c"
    {
    ...
    if (name_ptr != 
# 638 "/home/rudy/workspace/Projects/rt-thread/components/finsh/msh.c" 3 4
                   ((void *)0)
# 638 "/home/rudy/workspace/Projects/rt-thread/components/finsh/msh.c"
                       )
    {
